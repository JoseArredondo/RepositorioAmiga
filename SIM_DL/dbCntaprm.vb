...
Public Class dbCntaprm
    ...
    Public Overrides Function Agregar(ByVal aEntidad As entidadBase) As Integer
        ...
        strSQL.Append("INSERT INTO cntaprm ")
    ...
    Public Overrides Function Eliminar(ByVal aEntidad As entidadBase) As Integer
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("DELETE FROM cntaprm ")
        strSQL.Append(" WHERE cmesvig = @cmesvig ")
    ...
    Public Overrides Function ObtenerID(ByVal aEntidad As entidadBase) As Long
        ...
        strSQL.Append(" FROM cntaprm ")

        Return sql.ExecuteScalar(Me.cnnStr, CommandType.Text, strSQL.ToString())

    End Function

    Public Function ObtenerListaPorID() As listacntaprm
    ...
    Public Function ObtenerfiscaltoClose(ByVal ccodigo As String) As DataSet
        ...
        Dim strSQL As New StringBuilder
        strSQL.Append("Select dfecimes, dfecfmes, cmesvig FROM cntaprm WHERE cCierre='N'")
