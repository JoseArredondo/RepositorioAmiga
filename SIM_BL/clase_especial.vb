...
Public Class clase_especial
    ...
    Public Function buscar_asociado(ByVal con As SqlConnection, ByVal asociado As String) As DataSet
        ...
        If letra = "1" Or letra = "2" Or letra = "3" Or letra = "4" Or letra = "5" Or letra = "6" Or letra = "7" Or letra = "8" Or letra = "9" Or letra = "0" Then
            str_select = "select ccodcli as asociado, cnomcli as nombre, cnudoci as dui, cnudotr as nit,space(20) as  pin, cbenef1 as colegio " & _
    ...
    Public Function buscar_asociado1(ByVal con As SqlConnection, ByVal asociado As String) As DataSet
        ...
        If letra = "1" Or letra = "2" Or letra = "3" Or letra = "4" Or letra = "5" Or letra = "6" Or letra = "7" Or letra = "8" Or letra = "9" Or letra = "0" Then
            str_select = "select ccodcli as asociado, cnomcli as nombre, cnudoci as dui, cnudotr as nit, pin, cbenef1 as colegio " & _
                             " from climide where  substring(ccodcli,1,3) = '001' and ccodcli like " & "'%" & asociado.Trim & "%' order by ccodcli"
        Else
            str_select = "select ccodcli as asociado, cnomcli as nombre, cnudoci as dui, cnudotr as nit, pin, cbenef1 as colegio " & _
                             " from climide where  substring(ccodcli,1,3) = '001' and cnomcli like " & "'%" & asociado.Trim & "%' order by cnomcli"
        End If
    ...
    Public Function buscar_ctas_ahorro(ByVal con As SqlConnection, ByVal asociado As String, ByVal caso As Integer) As DataSet
        ...
        str_select = "select   aho.ccodaho as cuenta, " & _
                     ...
                     "when '04' then 'EDUCATIVO' " & _
                     "when '05' then 'MENORES' " & _
