<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbSolcred.ascx.vb" Inherits="WbSolcred" %>
    ...
    <tr>
        <td class="style9">
            <table align="center" cellpadding="0" cellspacing="0" class="style10">
                ...
                <tr>
                    <td align="right" class="style11">
                        <asp:label id="Label7" Font-Size="8pt" Width="63px" Font-Names="Verdana" 
        ...
        <td class="style9">
            <table align="center" cellpadding="0" cellspacing="0" class="style13">
                ...
                <tr>
                    ...
                    <td>
                        <select id="cbxanacre" 
                            style="FONT-SIZE: 12px; WIDTH: 279px; FONT-FAMILY: 'Verdana'" disabled
