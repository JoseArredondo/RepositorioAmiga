...
Partial Class CuwTraslados
    ...
    Private Sub btnaplicar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnaplicar.Click
        ...
        If lnPartida = 1 Then
            ...
            ReclasificacionCartera(Me.cbxtraslado.SelectedValue.Trim, lcglosa.Trim)
        End If
        ...
        If lnGrabar = 1 Then
            ...
            If pcnewcondic = "J" Or pcnewcondic = "S" Then
                i = ecremcre.ActualizaSuspensiondeCredito(Me.txtccodcta.Text.Trim, Session("gdfecsis"), "G", "99999")
    ...
    Public Sub ReclasificacionCartera(ByVal cCondic As String, ByVal cGlosa As String)
        ...
        entidadcremcre.ccodcta = Me.txtccodcta.Text.Trim
        ...
        k = ecremcre.ActualizaCondicion(Me.txtccodcta.Text.Trim, cCondic)
        Dim clsppal As New class1
        Dim lcaux As String
        lcaux = clsppal.ObtenerCodigoGarantia(Me.txtccodcta.Text.Trim)
        ...
        cClsAdP._ccodpres = Me.txtccodcta.Text.Trim
        ...
        Dim lnsalcap As Decimal = 0, lnsalint As Decimal = 0, lnsalmor As Decimal = 0
        lnsalcap = Math.Round(Double.Parse(Me.txtnsalcap.Text), 2)
        lnsalint = Math.Round(Double.Parse(txtnsalint.Text), 2)
        lnsalmor = Math.Round(Double.Parse(txtnsalmor.Text), 2)


        lnsaldos = Math.Round(Double.Parse(Me.txtnsalcap.Text) + Double.Parse(txtnsalint.Text) + Double.Parse(txtnsalmor.Text), 2)
