<%@ Control Language="vb" AutoEventWireup="false" Inherits="cuwFaltante" CodeFile="cuwFaltante.ascx.vb" %>
...
<TABLE id="Table8" style="border: thin solid highlight; WIDTH: 549px; HEIGHT: 275px; BACKGROUND-COLOR: #ffffff"
	...
	<TR>
		<TD style="HEIGHT: 33px" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<asp:label id="Label1" runat="server" Width="479px" Font-Bold="True" 
                Font-Size="Medium" Height="15px"
				Font-Names="Verdana" ForeColor="#16387C">REGISTRO DE OPERACIONES DE CAJA</asp:label></TD>
	</TR>
	<TR>
                ...
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="Label3" runat="server" Font-Names="Gill Sans MT" 
                            Text="Monto:" Width="140px"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="Label5" runat="server" Font-Names="Gill Sans MT" 
                            Text="Operacion:" Width="140px"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="Label6" runat="server" Font-Names="Gill Sans MT" 
                            Text="Nº Boleta:" Width="140px" Visible="False"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtBoleta" runat="server" 
                            Font-Names="Gill Sans MT" Width="104px" Visible="False"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style2" align="right">
	...
	<TR>
		<TD align="center">
            <asp:Button ID="Button1" runat="server" Font-Names="Gill Sans MT" Text="Registrar" 
                Width="104px" Font-Size="12pt" />
        </TD>
	</TR>
	<TR>
		<TD></TD>
