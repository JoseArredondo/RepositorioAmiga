<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbFindct.ascx.vb" Inherits="WbFindct"  %>
					...
					<TR>
						<TD style="WIDTH: 391px; HEIGHT: 41px">
							<P style="BACKGROUND-COLOR: #ffffff" align="right"><asp:label id="Label1" 
									...
									Height="16px" ForeColor="#16387C" Font-Bold="True">Nombre del Banco Comunal:</asp:label></P>
						</TD>
