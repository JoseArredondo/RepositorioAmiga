<%@ Control Language="vb" AutoEventWireup="false" Codefile="Wbgrupo.ascx.vb" Inherits="Wbgrupo"  %>
<style type="text/css">
    .style5
    {
        width: 97%;
...
<P>
	<TABLE id="Table1" style="border: thin solid highlight; WIDTH: 636px; HEIGHT: 424px; BACKGROUND-COLOR: #ffffff"
		...
		<TR>
			<TD style="HEIGHT: 20px">
				<P class="PageTitle" style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Verdana'"
					align="center">ABC DEL GRUPO</P>
				<P class="PageTitle" style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Verdana'"
					align="center"><asp:label id="Label6" Font-Size="8pt" Width="63px" Font-Names="Verdana" runat="server">Grupo:</asp:label><asp:textbox id="txtcnomcli" Font-Size="8pt" Width="321px" Font-Names="Verdana" runat="server"
		...
		<TR>
			<TD style="HEIGHT: 17px" bgColor="inactivecaption">
				<DIV style="DISPLAY: inline; FONT-SIZE: 10pt; WIDTH: 224px; COLOR: #000099; FONT-STYLE: normal; FONT-FAMILY: 'Century Gothic'; HEIGHT: 18px;"
		...
		<TR>
			<TD style="HEIGHT: 174px" align="center">
                <table border="1" cellpadding="0" cellspacing="0" class="style5" 
                    style="border-color: #000099; background-color: #99CCFF; height: 142px;">
                    <tr>
                        <td class="style6">
                            <asp:label id="Label1" Font-Size="8pt" Width="111px" Font-Names="Century Gothic" runat="server"
								ForeColor="#000040" Height="15px">Nombre del Grupo:</asp:label>
                        </td>
                        <td class="style7">
