<%@ Control Language="vb" AutoEventWireup="false" Inherits="WCProveedor" CodeFile="WCProveedor.ascx.vb" %>
...
<table cellpadding="0" cellspacing="0" class="style1" align="center">
    <tr>
        <td align="center">
				...
				Font-Bold="True" ForeColor="Maroon" Height="21px">PROVEEDORES</asp:label>
