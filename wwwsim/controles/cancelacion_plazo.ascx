<%@ Control Language="vb" AutoEventWireup="false" Codefile="cancelacion_plazo.ascx.vb" Inherits="cancelacion_plazo"  %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>

<head runat="server">
    <title>Cancelación a Depósitos a Plazo</title>
    <style type="text/css">
        .style1
        {
            width: 396px;
                ...
                <td class="style1">
                    &nbsp;
                        <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Names="Verdana" 
                            ...
                            Text="CANCELACION DEP. PLAZO" Width="394px"></asp:Label>
                    </td>
                <td>
                    &nbsp;
            ...
            <tr>
                <td class="style1">
                    ...
                    <asp:TextBox ID="asociado_TextBox" runat="server" Font-Names="Verdana" Font-Size="10pt" 
                        Width="370px" BorderWidth="1px"></asp:TextBox>
                ...
                <td>
                    ...
                    <asp:Button ID="buscar_Button" runat="server" BackColor="#99CC00" Font-Bold="False" 
                        Font-Names="Calibri" Font-Size="12pt" Text="Buscar" Width="81px" />
                ...
                <td>
                    <asp:Image ID="foto_Image" runat="server" Visible="False" Height="25px" 
                        Width="30px" BorderWidth="1px" />
                </td>
            </tr>
            <tr>
                <td class="style1">
    ...
    <table style="width: 69%;">
        <tr>
            <td class="style2">
                ...
                <asp:Label ID="cta_ahorro_Label" runat="server" Font-Names="Verdana" 
                    Font-Size="10pt" Text="Cuenta destino" Visible="False"></asp:Label>
            </td>
            <td class="style3">
              
                <asp:TextBox ID="cta_ahorro_TextBox" runat="server" Height="23px" Width="206px" 
        ...
        <tr>
            <td class="style2">
                ...
                <asp:Label ID="nueva_cta_ahorro_Label" runat="server" Font-Names="Verdana" 
                    Font-Size="10pt" Text="Nueva cuenta destino" Visible="False"></asp:Label>
            </td>
            <td class="style3">
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td class="style3">
                <asp:Button ID="cancelar_Button" runat="server" BackColor="#99CC00" 
                    Font-Bold="False" Font-Names="Calibri" Font-Size="12pt" Text="Pagar" 
                    Visible="False" Width="95px" />
            </td>
            <td>
                <asp:Button ID="imprimir_Button" runat="server" BackColor="#99CC00" 
                    Font-Bold="False" Font-Names="Calibri" Font-Size="12pt" Text="Imp. Partida" 
                    Visible="False" Width="95px" />
            </td>
        </tr>
        <tr>
