...
#Region " Metodos "
    ...
    Private Sub BuscaCredito()
        ...
        Else
            ...
            'Fuente de Ingreso
            'If IsDBNull(ds.Tables("Resultado").Rows(0)("cCodFue")) Then
            'Else
            ...
            Me.cbxcentros.SelectedValue = "001001000000" 'Trim(IIf(IsDBNull(lccodcen), "001001000000", lccodcen))
            'cargaGrupos()
