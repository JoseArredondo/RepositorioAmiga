...
#End Region
    ...
    Private Sub Cargagrid()
        ...
        If lcmetodologia = "Cliente" Then
            lcmetodologia = "1"
            Me.busquedaindividual()
        Else
            lcmetodologia = "2"
            ds = clsfind.Obtenerbusquedacredito(nombre, lcestado, lctipo, lcbusq, lcmetodologia, "02", Session("gcCodofi"))
            i = 0
...
#End Region
    ...
    Private Sub busquedaindividual()
        ...
        ds = clsfind.ObtenerbusquedacreditoAmbos(nombre, lcestado, lctipo, lcbusq, lcmetodologia, "01", Session("gcCodofi"))
        i = 0
        Dim lccodrec As String
