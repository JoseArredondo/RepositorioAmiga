...
Partial Class controles_Contenedor_Ahorros
    Inherits System.Web.UI.UserControl

#Region "Metodos"
    Private Sub Carga_Informe()
        ...
        parm1 = "rpt_dividendos_calculados" Or parm1 = "rpt_dividendos_pendientes" Then
            con.Open()
            str_select = Session("str_select")
            ds = miclase.devolver_dataset(con, str_select)
            con.Close()
        ...
        If parm1 = "pago_intereses_tasa" Then  'viene del formulario rpt_pago_interes_plazo
            crrep.Load(huella & "pago_intereses_tasa.rpt")
        End If
        ...
        Dim empresa As String = "AMIGA"
        crrep.SetParameterValue("empresa", empresa)

        If parm1 = "rpt_movimientos_diarios_ahorros" Or parm1 = "pago_intereses" Or parm1 = "pago_intereses_acumulado" Or _
            parm1 = "rpt_provision_diaria" Or parm1 = "resumen_provision_ahorros" Or parm1 = "certificados" Or _
            parm1 = "pignorados" Or parm1 = "rpt_cartera_ahorros" Or parm1 = "pago_intereses" Or parm1 = "pago_intereses_acumulado" Then
            crrep.SetParameterValue("pcnomOfi", Session("pcNomOfi"))
        End If
...
#End Region
    ...
    Private Function caso_especial1(ByVal con As SqlConnection) As DataTable
        ...
        str_select = "select  'CERTIFICADOS PIGNORADOS' as titulo, crt.cnudotr, rtrim(crt.ccodcrt) + ' ' + rtrim(crt.cctacte) as ccodcrt, " & _
        ...
        str_select = "select  distinct 'CERTIFICADOS PIGNORADOS' as titulo, crt.cnudotr, rtrim(crt.ccodcrt) + ' ' + rtrim(crt.cctacte) as ccodcrt, " & _
