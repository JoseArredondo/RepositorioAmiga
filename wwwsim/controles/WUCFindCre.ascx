<%@ Control Language="vb" AutoEventWireup="false" Codefile="WUCFindCre.ascx.vb" Inherits="WUCFindCre"  %>
			...
			<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="536" border="0" style="WIDTH: 536px; HEIGHT: 48px">
				<TR>
					<TD style="WIDTH: 222px" align="right">
						<asp:label id="Label1" Font-Bold="True" ForeColor="#16387C" Height="11px" Font-Size="10pt"
							Font-Names="Verdana" Width="144px" runat="server">Nombre del Cliente:</asp:label></TD>
					<TD style="WIDTH: 238px">
						<P align="left">
							<asp:textbox id="TxtNombre" tabIndex="1" Width="320px" runat="server" ToolTip="Digite el Nombre del Cliente"
								BorderWidth="1px" Font-Names="Verdana" BorderColor="#2E6A99" Height="30px" 
                                style="margin-bottom: 0px"></asp:textbox></P>
					</TD>
					<TD style="WIDTH: 80px">
