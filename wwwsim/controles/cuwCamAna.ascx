<%@ Control Language="vb" AutoEventWireup="false" Inherits="cuwCamAna" CodeFile="cuwCamAna.ascx.vb" %>
	...
	<TR>
		<TD style="HEIGHT: 20px">
			<P class="PageTitle" style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Verdana'"
				align="center">CAMBIO DE ANALISTA</P>
			<P class="PageTitle" style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Verdana'"
				align="center">
							...
							<TABLE id="Table2" style="WIDTH: 386px; HEIGHT: 117px" borderColor="inactivecaption" cellSpacing="0"
								...
								<TR>
									<TD style="WIDTH: 141px" align="right">
										<asp:Label id="Label1" Font-Size="8pt" Width="102px" Font-Names="Verdana" runat="server" ForeColor="Navy">Nombre Cliente:</asp:Label></TD>
									<TD>
								...
								<TR>
									<TD style="WIDTH: 141px" align="right">
										<asp:Label id="Label3" Font-Size="8pt" Width="100px" Font-Names="Verdana" runat="server" ForeColor="Navy">Codigo Crédito:</asp:Label></TD>
									<TD>
										<asp:textbox id="txtccodcta" Font-Size="8pt" Width="186px" Font-Names="Verdana" runat="server"
											Font-Bold="True" Enabled="False" BorderWidth="1px"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 141px" align="right">
								...
								<TR>
									...
									<TD><SELECT id="cbxanacre" style="FONT-SIZE: 12px; WIDTH: 258px; FONT-FAMILY: 'Verdana'" disabled
