...
#Region " Metodos "
    ...
    Public Sub CargaCombos()
        ...
        mListaTabttab = clstabttab.ObtenerLista("127", "1")
...
#End Region
    ...
    Protected Sub btgrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btgrabar.Click
        ...
        Else
            ...
            End If
        End If
        If TxtNomcli.Text.Trim = "" Or Txtpriape.Text.Trim = "" Or TxtIdCivil.Text.Trim = "" Or _
         TxtDirDom.Text.Trim = "" Or TxtDfecnaci.Text.Trim = "" Then 'Valida espacios en blanco en campos principales
            Response.Write("<script language='javascript'>alert('Faltan Datos Verifique ')</script>")
            Exit Sub
        End If
        ...
        'cClsAdCli._cNomcli = Me.TxtNomcli.Text.Trim.ToUpper + IIf(Txtsegnom.Text.Trim = "", "", " ") + Txtsegnom.Text.Trim + IIf(Txtternom.Text.Trim = "", "", " ") + Txtternom.Text.Trim + IIf(Txtpriape.Text.Trim = "", "", " ") + _
        'Txtpriape.Text.Trim(+IIf(Txtsegape.Text.Trim = "", "", " ") + Txtsegape.Text.Trim + IIf(Txtapecasada.Text.Trim = "", "", " ") + Txtapecasada.Text.Trim)
...
Txtpriape.Text.Trim.ToUpper + IIf(Txtsegape.Text.Trim = "", "", " ") + Txtsegape.Text.Trim.ToUpper + IIf(Txtapecasada.Text.Trim = "", "", " DE  ") + Txtapecasada.Text.Trim.ToUpper
        ...
        Dim clsppal As New class1
        clsppal.Auditoria(Session("gccodusu"), Session("gdfecsis"), "Gr", 91)
