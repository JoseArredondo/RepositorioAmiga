...
Partial Class controles_Ahorros_WbUCDepAho
    Inherits ucWBase
...
#End Region
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        lctippag = "P" 'etabttab.ObtieneTipoCajero(Me.ddlcajero.SelectedValue.Trim)
        ...
        If (lccodaho <> Nothing And lccodaho.Trim <> "") And (lnefectivo > 0 Or lncheque > 0 Or lnotros > 0) Then
            ...
            Try
                ...
                lcctactb = Me.CbxCtaCTB1.SelectedValue.Trim
