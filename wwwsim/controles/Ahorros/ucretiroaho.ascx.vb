...
#End Region
        ...
        If (lccodaho <> Nothing And lccodaho.Trim <> "") And (lnefectivo > 0 Or lncheque > 0 Or lnotros > 0) Then
            ...
            Try
                ...
                If chkcheque.Checked = True Then 'validar datos del cheque
                    ...
                    End If
                    If txtnroche.Text.Trim = "" Then
                        'Response.Write("<script language='javascript'>alert('Digitar Nº de Cheque ')</script>")
                        codigoJs = "<script language='javascript'>alert('Digitar Nº de Cheque, " & _
                               "Advertencia SIM.NET ')</script>"
                    ...
                    If lverifica = True Then
                        'Response.Write("<script language='javascript'>alert('Nº de Cheque ya Existe ')</script>")
                        codigoJs = "<script language='javascript'>alert('Nº de Cheque ya Existe, " & _
                               "Advertencia SIM.NET ')</script>"
                ...
                If lccodaho.Trim.Substring(6, 2) = "08" Then
                    If Month(Session("gdfecsis")) > 12 Then
                        'Response.Write("<script language='javascript'>alert('Retiro de Ahorro Navideño en mes Incorrecto')</script>")
                        codigoJs = "<script language='javascript'>alert('Retiro de Ahorro Navideño en mes Incorrecto, " & _
                               "Advertencia SIM.NET ')</script>"
                ...
                If chkcheque.Checked = True Then
                    ...
                    'Response.Write("<script language='javascript'>alert('Ok, Imprima Voucher Nº:  " & lcnumpar & " ')</script>")
                    codigoJs = "<script language='javascript'>alert('Ok, Imprima Voucher Nº:  " & lcnumpar & " '"
    ...
    Protected Sub btnaplicar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnaplicar.Click
        ...
        Session("fuente") = "1"
        '-------------verifica meses de bloqueo para ahorro navideño y educativo
        ...
        If lccodaho.Substring(6, 2) = "06" Then
            ...
            Session("fuente") = "0"
            'Response.Write("<script language='javascript'>alert('No puede retirar de aportaciones, sin autorización.')</script>")
            'Response.Write("<script>window.open('wfAcceso.aspx','cal', 'location=1, toolbar = no, status=1,width=550,height=300')</script>")

            codigoJs = "<script language='javascript'>alert('No puede retirar de aportaciones, sin autorización " & _
                       "Advertencia SIM.NET ')</script>"
