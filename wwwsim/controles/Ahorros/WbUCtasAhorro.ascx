<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WbUCtasAhorro.ascx.vb" Inherits="controles_Ahorros_WbUCtasAhorro" %>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <table cellpadding="0" cellspacing="0" class="style17">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="border: 1pt groove #FFFFFF; text-align: center" class="style47">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td style="text-align: left" class="style48">
                                                                                                                                <asp:TextBox ID="TxtcEvalua" runat="server" BorderColor="#2E6A99" 
                                                                                                                                    ...
                                                                                                                                    Height="25px" TabIndex="4" Width="350px" CssClass="transpare"></asp:TextBox>
                                                                                                                            ...
                                                                                                                            <td class="style48" style="text-align: center">
                                                                                                                                <asp:Button ID="btnbuscar" runat="server" Font-Bold="True" 
                                                                                                                                    Font-Names="calibri" Font-Size="9pt" Height="24px" Text="Buscar" 
                                                                                                                                    Width="171px" />
                                                                                                                            </td>
                                                                                                                            <td>
                                                                                                                                <asp:RadioButtonList ID="llBandera_Socio" runat="server" Font-Names="Calibri" 
                                                                                                                                    Font-Size="10pt" Width="90px" Visible="False">
                                                                                                                                    <asp:ListItem Value="01">Y</asp:ListItem>
                                                                                                                                    <asp:ListItem Value="02">O</asp:ListItem>
                                                                                                                                    <asp:ListItem Selected="True" Value="03">Sin Acción</asp:ListItem>
                                                                                                                                </asp:RadioButtonList>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                            ...
                                            <tr>
                                                <td class="style32">
                                                    <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Names="Calibri" 
                                                        Font-Size="12pt" Text="APERTURA DE CUENTAS"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="style32">
                                                        ...
                                                        <tr>
                                                            <td class="style60">
                                                                <asp:Label ID="lblUsuario86" Runat="server" Font-Names="Calibri" 
                                                                    Font-Size="9pt" style="text-align: left" Width="100px">Codigo :</asp:Label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td class="style60">
                                                                <asp:Label ID="lblUsuario103" Runat="server" Font-Names="Calibri" 
                                                                    Font-Size="9pt" Height="16px" style="text-align: left" Width="100px">No Cta :</asp:Label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td class="style60">
                                                                <asp:Label ID="lblUsuario87" Runat="server" Font-Names="Calibri" 
                                                                    Font-Size="9pt" style="text-align: left" Width="100px">Nombre :</asp:Label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc2:CalendarExtender ID="Calendar_Ext1" runat="server" Enabled="True" 
                                                                    Format="dd/MM/yyyy" PopupButtonID="Image_btn1" TargetControlID="Txtdfeccnt">
                                                        ...
                                                        <tr>
                                                            <td class="style60">
                                                                <asp:Label ID="lblUsuario102" Runat="server" Font-Names="Calibri" 
                                                                    Font-Size="9pt" style="text-align: left" Width="100px">Linea :</asp:Label>
                                                            </td>
                                                            <td>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" class="style34">
                                                                            <tr>
                                                                                ...
                                                                                <td class="style62" style="text-align: center">
                                                                                    <asp:Label ID="lblUsuario97" Runat="server" Font-Names="Calibri" 
                                                                                        Font-Size="9pt">Nombre:</asp:Label>
                                                                                </td>
                                                                                <td style="text-align: center">
                                                                                    <asp:Label ID="lblUsuario98" Runat="server" Font-Names="Calibri" 
                                                                                        Font-Size="9pt" Height="26px" style="text-align: center" Width="142px">Fecha Nacimiento:</asp:Label>
                                                                                </td>
                                                                                <td style="text-align: center">
                                                                                    <asp:Label ID="lblUsuario100" Runat="server" Font-Names="calibri" 
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: center">
                                                                                    <asp:TextBox ID="TxtcnudociFir" runat="server" AutoPostBack="True" 
                                                                                        BorderColor="#2E6A99" BorderWidth="1px" Enabled="False" Font-Names="Verdana" 
                                                                                        Font-Size="8pt" Height="20px" TabIndex="13" Width="105px"></asp:TextBox>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" class="style36">
                                                                            <tr>
                                                                                <td class="style45" style="text-align: center">
                                                                                    <asp:Label ID="lblUsuario30" Runat="server" Font-Names="Calibri" 
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center">
                                                                <asp:Button ID="btnnew" runat="server" Font-Bold="True" Font-Names="Calibri" 
                                                                    Font-Size="9pt" Height="27px" Text="Nuevo" Width="120px" />
                                                            </td>
                                                            <td style="text-align: center">
