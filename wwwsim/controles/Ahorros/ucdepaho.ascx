<%@ Control Language="vb" AutoEventWireup="false" Inherits="ucdepaho" CodeFile="ucdepaho.ascx.vb" %>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:label id="Label1" Font-Bold="True" Font-Names="Verdana" 
                                                ForeColor="#16387C" Width="278px"
				runat="server" Font-Size="Medium" Height="15px">DEPOSITO DE AHORROS</asp:label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        Text="Lavado de Dinero" Width="130px" Visible="False" />
                                        ...
                                        Height="27px" Text="ReImp. Rec" Width="84px" Visible="False" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
