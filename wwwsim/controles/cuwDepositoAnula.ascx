<%@ Control Language="vb" AutoEventWireup="false" Inherits="cuwDepositoAnula" CodeFile="cuwDepositoAnula.ascx.vb" %>
...
<TABLE id="Table8" style="border: thin solid highlight; WIDTH: 549px; HEIGHT: 275px; BACKGROUND-COLOR: #ffffff"
	...
	<TR>
		<TD style="HEIGHT: 33px" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<asp:label id="Label1" runat="server" Width="278px" Font-Bold="True" Font-Size="Medium" Height="15px"
				Font-Names="Verdana" ForeColor="#16387C">REVERSION DE DEPOSITOS </asp:label></TD>
	</TR>
	<TR>
                ...
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="Label2" runat="server" Font-Names="Gill Sans MT" 
                            Text="Fecha de Deposito:"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="Label3" runat="server" Font-Names="Gill Sans MT" 
                            Text="Monto a Depositar:" Width="140px" Visible="False"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtnsalini" runat="server" Font-Names="Gill Sans MT" 
                ...
                <tr>
                    <td class="style2" align="right">
                        <asp:Label ID="Label6" runat="server" Font-Names="Gill Sans MT" 
                            Text="Nº Boleta a Revertir:" Width="140px"></asp:Label>
                    </td>
                    <td>
	...
	<TR>
		<TD align="center">
            <asp:Button ID="Button1" runat="server" Font-Names="Gill Sans MT" Text="Revertir" 
                Width="104px" />
        </TD>
	</TR>
	<TR>
