<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbCBA.ascx.vb" Inherits="WbCBA" %>
...
<table cellpadding="0" cellspacing="0" class="style8" 
    ...
    <tr>
        <td align="center" class="style9" 
            ...
            style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Verdana'">
                        Preguntas destinadas a evaluar los gastos del hogar, Canasta Basica Alimentaria 
                        (CBA) y Canasta Básica Vital (CBV)</td>
    </tr>
    <tr>
        <td align="center" class="style9" 
								    ...
								    <asp:TemplateColumn HeaderText="Cantidad">
                                        <ItemTemplate>
                                            ...
                                            <asp:RangeValidator ID="RangeValidator2" runat="server" 
                                                ControlToValidate="TextBox5" ErrorMessage="RangeValidator" Font-Names="Verdana" 
