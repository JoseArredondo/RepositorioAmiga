<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbRechazar.ascx.vb" Inherits="WbRechazar" %>
    ...
    <tr>
        <td class="style14">
            <table cellpadding="0" cellspacing="0" class="style10">
                ...
                <tr>
                    <td class="style11">
                        <asp:label id="Label11" Font-Size="8pt" Width="134px" Font-Names="Verdana" 
                            runat="server">Codigo de Préstamo:</asp:label>
                    </td>
                    <td>
                        <INPUT id="txtccodcta" style="FONT-SIZE: 12px; WIDTH: 194px; FONT-FAMILY: 'Verdana'; HEIGHT: 22px"
