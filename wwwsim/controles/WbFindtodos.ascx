<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbFindtodos.ascx.vb" Inherits="WbFindtodos"  %>
<TABLE id="Table3" style="BORDER-RIGHT: highlight thin solid; BORDER-TOP: highlight thin solid; BORDER-LEFT: highlight thin solid; WIDTH: 616px; BORDER-BOTTOM: highlight thin solid; HEIGHT: 306px; BACKGROUND-COLOR: #ffffff"
	...
	<TR>
		<TD style="WIDTH: 903px">
			<P align="center"><asp:label id="Label2" runat="server" Width="621px" 
                    Font-Names="Calibri" Font-Size="Medium"
					Height="15px" ForeColor="#16387C" Font-Bold="True">BUSQUEDA DE GRUPOS 
                SOLIDARIOS/BANCOS COMUNALES</asp:label></P>
		</TD>
	</TR>
	<TR>
				...
				<TBODY>
					<TR>
						...
						<TD style="WIDTH: 275px; HEIGHT: 41px">
							<P align="left"><asp:textbox id="TxtNombre" tabIndex="1" runat="server" 
                                    Width="400px" Font-Names="Verdana" BorderWidth="1px"
									ToolTip="Digite el Nombre del Cliente" BorderColor="#2E6A99" Height="25px"></asp:textbox></P>
						</TD>
