...
#End Region
    ...
    Private Sub cargadatos()
        ...
        lccuenta = etabtbco.CuentaContableBanco(cmbBancos.SelectedValue.Trim)


        lcbanco = IIf(CheckBox1.Checked = True, "00", lccuenta)
        ...
        If Me.RdBFind1.Checked = True Then
            ds = cClsPart.ObtenerBusquedaPartidaBancaria(Session("gcfondo"), lccadena, lcbanco, lcnrochq, ldfecini, ldfecfin, 1, Me.Txtdescri.Text.Trim)
        ElseIf Me.RdBFind2.Checked = True Then
            ds = cClsPart.ObtenerBusquedaPartidaBancaria(Session("gcfondo"), lccadena, lcbanco, lcnrochq, ldfecini, ldfecfin, 2, Me.Txtdescri.Text.Trim)
        ElseIf CheckBox3.Checked = True And (RdBFind1.Checked = False And RdBFind2.Checked = False And RdBFind4.Checked = False) Then
            'ds = cClsPart.BuscaPartidaFechas(ldfecini, ldfecfin, Session("gcfondo"), lccadena, lccodofi, "*") 'Descripcion
        ...
        ElseIf Me.RdBFind4.Checked = True Then
            ds = cClsPart.ObtenerBusquedaPartidaBancaria(Session("gcfondo"), lccadena, lcbanco, lcnrochq, ldfecini, ldfecfin, 3, Me.Txtdescri.Text.Trim)
        End If
