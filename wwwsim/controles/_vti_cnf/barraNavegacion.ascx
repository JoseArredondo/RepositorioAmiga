<%@ Control Language="vb" AutoEventWireup="false" Codebehind="barraNavegacion.ascx.vb" Inherits="wwwSIM.barraNavegacion" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
