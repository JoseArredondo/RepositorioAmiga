<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucingresos.ascx.vb" Inherits="wwwSIM.ucingresos" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
