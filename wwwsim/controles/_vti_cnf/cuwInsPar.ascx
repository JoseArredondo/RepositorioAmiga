<%@ Control Language="vb" AutoEventWireup="false" Codebehind="cuwInsPar.ascx.vb" Inherits="wwwSIM.cuwInsPar" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
