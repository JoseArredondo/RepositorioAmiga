<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucadiccer.ascx.vb" Inherits="wwwSIM.ucadiccer" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
