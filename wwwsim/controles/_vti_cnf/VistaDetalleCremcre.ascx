<%@ Control Language="vb" AutoEventWireup="false" Codebehind="VistaDetalleCremcre.ascx.vb" Inherits="wwwSIM.VistaDetalleCremcre" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
