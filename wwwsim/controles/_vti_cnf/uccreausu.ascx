<%@ Control Language="vb" AutoEventWireup="false" Codebehind="uccreausu.ascx.vb" Inherits="wwwSIM.uccreausu" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
