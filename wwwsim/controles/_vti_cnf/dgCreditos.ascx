<%@ Control Language="vb" AutoEventWireup="false" Codebehind="dgCreditos.ascx.vb" Inherits="wwwSIM.dgCreditos" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
