<%@ Control Language="vb" AutoEventWireup="false" Codebehind="cwRecSol.ascx.vb" Inherits="wwwSIM.cwRecSol" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
