<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucretaho.ascx.vb" Inherits="wwwSIM.ucretaho" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
