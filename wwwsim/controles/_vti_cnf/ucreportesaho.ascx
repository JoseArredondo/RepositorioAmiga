<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucreportesaho.ascx.vb" Inherits="wwwSIM.ucreportesaho" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
