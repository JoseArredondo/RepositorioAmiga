<%@ Control Language="vb" AutoEventWireup="false" Codebehind="dgbuscre.ascx.vb" Inherits="wwwSIM.dgbuscre" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
