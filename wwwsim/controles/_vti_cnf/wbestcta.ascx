<%@ Control Language="vb" AutoEventWireup="false" Codebehind="wbestcta.ascx.vb" Inherits="wwwSIM.wbestcta" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
