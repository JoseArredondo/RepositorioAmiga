<%@ Control Language="vb" AutoEventWireup="false" Codebehind="dgKardex.ascx.vb" Inherits="wwwSIM.dgKardex" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
