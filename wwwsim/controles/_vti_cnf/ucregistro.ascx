<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucregistro.ascx.vb" Inherits="wwwSIM.ucregistro" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
