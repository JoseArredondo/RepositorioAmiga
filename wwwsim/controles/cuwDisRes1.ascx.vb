...
#End Region
    ...
    Private Sub btnprocesar_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnprocesar.ServerClick
        ...
        dsResultado = classconta.GenResultado()
        ...
        Try
            ...
            crRpt.Load(Server.MapPath("reportes") + "\crResultado.rpt", OpenReportMethod.OpenReportByDefault)
        Catch ex As Exception
            Return
        End Try

        ' Setear los registros recuperados, diciendole el Table respectivo
        crRpt.SetDataSource(dsResultado)
