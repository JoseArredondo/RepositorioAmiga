<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbUsFindChq.ascx.vb" Inherits="WbUsFindChq"  %>
	...
	<TR>
		<TD align="center">
			<asp:label id="Label1" Font-Size="Medium" Font-Names="Verdana" runat="server" Width="384px"
				ForeColor="#16387C" Font-Bold="True" Height="15px">BUSQUEDA DE  CHEQUES</asp:label>
        </TD>
	</TR>
	<TR>
		<TD align="center">
				...
				<TR>
					<TD style="WIDTH: 390px; HEIGHT: 19px">
                            ...
                            Text="Otros Criterios:" Width="184px" Font-Names="Verdana"
								Font-Size="8pt" Height="23px" GroupName="busqueda" Checked="True"></asp:RadioButton>
					</TD>
				</TR>
				<TR>
					<TD style="WIDTH: 390px; HEIGHT: 19px">
			<TABLE id="Table4" cellSpacing="0" cellPadding="0" border="0" style="WIDTH: 498px; HEIGHT: 56px"
				...
				<TR>
					<TD class="style4" align="right">
                                    <asp:Label ID="Label6" runat="server" Font-Names="Calibri" Font-Size="10pt" 
                                        Text="Nº de Cheque:"></asp:Label>
					</TD>
					<TD class="style6">
                        <asp:TextBox ID="TextBox1" runat="server" Font-Names="Calibri" Font-Size="10pt"></asp:TextBox>
                        </TD>
					<TD>
				...
				<TR>
					<TD style="WIDTH: 390px; HEIGHT: 19px" align="center">
