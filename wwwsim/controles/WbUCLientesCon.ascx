<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbUCLientesCon.ascx.vb" Inherits="WbUCLientesCon"  %>
					...
					<TR>
						...
						<TD style="FONT-SIZE: 10pt; " class="style15">
                            <asp:Label ID="Label5" runat="server" Font-Names="Gill Sans MT" Font-Size="10pt" 
                                ForeColor="#000066" Text="Nº Dependientes:" Width="107px"></asp:Label>
                        </TD>
					...
					<TR>
						<TD style="FONT-WEIGHT: normal; FONT-SIZE: 10pt; WIDTH: 114px; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Gill Sans MT'; HEIGHT: 16px">
                            <asp:Label ID="Label18" runat="server" Font-Names="Gill Sans MT" Font-Size="10pt" 
                                ForeColor="#000066" Text="Nº Hijos:" Width="107px"></asp:Label>
                        </TD>
						<TD class="style10">
			...
			<TD style="FONT-SIZE: 11pt" class="style39">
					...
					<tr>
						<td 
                            ...
                            style="FONT-WEIGHT: normal; FONT-SIZE: 10pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Gill Sans MT'; TEXT-DECORATION: none" 
                            class="style60">
                            <asp:Label runat="server" Text="Dueño:" Font-Names="Gill Sans MT" 
                                Font-Size="10pt" ForeColor="#000066" Width="90px" ID="Label36" Height="16px"></asp:Label>

                        </td>
						<td class="style61">
                            <asp:TextBox runat="server" Enabled="False" Font-Names="Gill Sans MT" 
                                Font-Size="10pt" Height="23px" TabIndex="28" Width="208px" ID="txtdueño"></asp:TextBox>
					...
					<tr>
						<td 
                            ...
                            style="FONT-WEIGHT: normal; FONT-SIZE: 10pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Gill Sans MT'; TEXT-DECORATION: none" 
                            class="style63">
                            <asp:Label runat="server" Text="Año desde que Reside:" 
		...
		<TR>
			<TD style="HEIGHT: 69px">
				<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TR>
						<TD style="FONT-WEIGHT: normal; FONT-SIZE: 10pt; WIDTH: 100px; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Gill Sans MT'; HEIGHT: 22px">Profesión</TD>
