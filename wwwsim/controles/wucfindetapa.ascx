<%@ Control Language="vb" AutoEventWireup="false" Codefile="wucfindetapa.ascx.vb" Inherits="wucfindetapa"  %>
		...
		<TD align="center">
				...
				<TR>
					...
					<TD style="WIDTH: 178px">
						<asp:radiobuttonlist id="rdbbusqueda2" ForeColor="#16387C" Height="149px" 
							...
							BorderWidth="2px" BorderColor="Navy">
							<asp:ListItem Value="Proceso de Solicitud" Selected="True">Proceso de Solicitud</asp:ListItem>
							<asp:ListItem Value="Proceso de Sugerencia">Proceso de Sugerencia</asp:ListItem>
							<asp:ListItem>Proceso de Pre-Autorizado</asp:ListItem>
						</asp:radiobuttonlist></TD>
			...
			<DIV style="BACKGROUND-COLOR: #ffffff" align="center"><asp:datagrid id="dgClientes" 
					...
					<Columns>
					    ...
					    <asp:BoundColumn DataField="cnudoci" HeaderText="DPI/Cedula" 
