<%@ Control Language="vb" AutoEventWireup="false" Codefile="WbFindbcReimpresion.ascx.vb" Inherits="WbFindbcReimpresion"  %>
<style type="text/css">
    .style1
    {
        width: 391px;
		...
		<TD style="WIDTH: 904px">
			...
			<DIV style="BACKGROUND-COLOR: #ffffff" align="center"><asp:datagrid id="dgClientes" runat="server" Width="594px" Height="178px" BorderWidth="1px" BorderStyle="None"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="cnomcli" SortExpression="cnomgru" 
                            HeaderText="Banco/Grupo">
							<HeaderStyle Font-Size="X-Small" Font-Names="Century Gothic" HorizontalAlign="Center" VerticalAlign="Top"></HeaderStyle>
							<ItemStyle Font-Size="XX-Small" Font-Names="Century Gothic" HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
						</asp:BoundColumn>
					    <asp:BoundColumn DataField="ncapdes" HeaderText="Monto Des.">
					    <HeaderStyle Font-Size="X-Small" Font-Names="Century Gothic" HorizontalAlign="Center" VerticalAlign="Top"></HeaderStyle>
							<ItemStyle Font-Size="XX-Small" Font-Names="Century Gothic" HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
					    </asp:BoundColumn>
					    <asp:BoundColumn DataField="dfecvig" HeaderText="Fecha Des.">
					    <HeaderStyle Font-Size="X-Small" Font-Names="Century Gothic" HorizontalAlign="Center" VerticalAlign="Top"></HeaderStyle>
							<ItemStyle Font-Size="XX-Small" Font-Names="Century Gothic" HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
					    </asp:BoundColumn>
					</Columns>
