<%@ Control Language="vb" AutoEventWireup="false" Codefile="CUWPreAprLote.ascx.vb" Inherits="CUWPreAprLote"  %>
        ...
        <td>
                ...
                <tr>
                    <td class="style32">
                        <table align="left" bgcolor="White" cellpadding="0" cellspacing="0" 
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" class="style11">
                                        <tr>
                                            ...
                                            <td class="style14">
                                                <asp:dropdownlist id="cbxcodofi" runat="server" Width="161px" Font-Names="Century Gothic" Font-Size="8pt"></asp:dropdownlist>
                                            </td>
                                            <td>
                            ...
                            <tr>
								...
								<OPTION selected></OPTION>
									...
									Height="32px" AutoPostBack="True" Enabled="False"></asp:dropdownlist>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <asp:DropDownList ID="cbxprograma" runat="server" 
                            Font-Names="Century Gothic" Font-Size="8pt" Height="19px" Width="314px" AutoPostBack="True" 
                                                    Enabled="False">
                        </asp:DropDownList>
                                            </td>
                                        </tr>
								...
								BorderWidth="1px" Enabled="False" Height="19px"></asp:textbox>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txttasa" runat="server" BorderWidth="1px" 
                                                    Font-Names="Gill Sans MT" Font-Size="10pt" Height="18px" 
                                                    onchange="ValidaTasa();" Width="91px" Enabled="False" Visible="False"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="style26">
			...
			<asp:datagrid id="Datagrid1" AllowSorting="True" 
                ...
                Height="16px" Width="645px"
								...
								<HeaderStyle Font-Bold="True" ForeColor="White" BackColor="#CC3300"></HeaderStyle>
								...
								<Columns>
								    ...
								    <asp:BoundColumn DataField="nmonsug" HeaderText="Monto Sugerido" 
                                        SortExpression="nmonsug" DataFormatString="{0:$###,##0.00}">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Names="Calibri" 
                                            Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" 
                                            Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Names="Calibri" 
								    ...
								    <asp:TemplateColumn HeaderText="Monto Aprobado">
                                        <ItemTemplate>
                                            <asp:TextBox ID="TextBox2" runat="server" BackColor="Yellow" 
                                                Font-Names="Calibri" Font-Size="12pt" Height="27px" 
                                                Text='<%# DataBinder.Eval(Container, "DataItem.nmonapr") %>' Width="80px" 
                                                Enabled="False"></asp:TextBox>
                            ...
                            <tr>
								...
								type="button" name="Button5" runat="server" visible="False" onclick="return btnAplicar_onclick()"></td>
                                            <td class="style36">
