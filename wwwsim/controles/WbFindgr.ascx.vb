...
#Region " Metodos de la Pagina "
    Private Sub Cargardatos()
        ...
        'Dim i As Integer
        'ds = clsCli.BuscaCliente(Me.TxtNombre.Text.Trim, Me.cbxcentros.SelectedValue.Trim, "03")
        ...
        'End If
        Dim i As Integer
        ds = clsCli.BuscaClienteGru(Me.TxtNombre.Text.Trim, Me.cbxcentros.SelectedValue.Trim, "03", Session("gcCodofi"))
        i = ds.Tables(0).Rows.Count()
        If i >= 1 Then
            Me.dgClientes.DataSource = ds.Tables(0)
            Me.dgClientes.DataBind()
...
#End Region
    ...
    Private Sub dgClientes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgClientes.SelectedIndexChanged
        ...
        ClienteSeleccionado = dgclientes.SelectedRow.Cells(1).Text.ToString 'asociado
