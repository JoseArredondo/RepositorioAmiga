<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WbUCDispersaGar.ascx.vb" Inherits="controles_Creditos_WbUCDispersaGar" %>
		...
		<TD style="HEIGHT: 19px">
			<P style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Gill Sans MT'; BACKGROUND-COLOR: #ffffff"
				align="center">
                    ...
                    Width="400px">GENERA ARCHIVO DISPERSADOR GARANTIAS</asp:Label>
                                                            </P>
		</TD>
	</TR>
	<TR>
