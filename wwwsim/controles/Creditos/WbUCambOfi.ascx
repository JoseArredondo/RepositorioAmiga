<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WbUCambOfi.ascx.vb" Inherits="controles_Creditos_WbUCambOfi" %>
	...
	<TR>
		<TD align="center">
			<P style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Gill Sans MT'; BACKGROUND-COLOR: #ffffff"
				align="center">CAMBIO DE OFICINA</P>
		</TD>
	</TR>
	<TR>
                            ...
                            <tr>
                                <td class="style6">
                                    <asp:label id="Label18" runat="server" Font-Names="Gill Sans MT" 
                                        Font-Size="10pt">Oficina Origen:</asp:label>
                                </td>
                                <td class="style6">
                                    <cc2:CbxOficinas ID="CbxOficinas_Origen" runat="server" Enabled="False" 
                                        Font-Names="Gill Sans MT" Font-Size="10pt" Height="21px" Width="300px">
                                    </cc2:CbxOficinas>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:label id="Label19" runat="server" Font-Names="Gill Sans MT" 
                                        Font-Size="10pt">Oficina Destino:</asp:label>
                                </td>
                                <td>
                                    <cc2:CbxOficinas ID="CbxOficinas_Destino" runat="server" Enabled="False" 
                                        Font-Names="Gill Sans MT" Font-Size="10pt" Height="21px" Width="300px">
                                    </cc2:CbxOficinas>
                                </td>
                            </tr>
				...
				<TR>
					<TD align="center" class="style3">
                        ...
                        <cc1:ConfirmButtonExtender ID="Button1_ConfirmButtonExtender" runat="server" 
                            ConfirmText="Seguro de Modificar la Oficina?" Enabled="True" TargetControlID="Button1">
