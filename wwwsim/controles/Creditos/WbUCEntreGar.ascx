<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WbUCEntreGar.ascx.vb" Inherits="controles_Creditos_WbUCEntreGar" %>
	...
	<TR>
		<TD align="center">
			<P style="FONT-WEIGHT: bold; FONT-SIZE: 14pt; COLOR: #16387c; FONT-STYLE: normal; FONT-FAMILY: 'Verdana'; BACKGROUND-COLOR: #ffffff"
				align="center">ENTREGA DE GARANTIA LIQUIDA<asp:GridView ID="Grid_Garantia" runat="server" 
		...
		<TD align="center">
			<TABLE id="Table3" style="WIDTH: 438px; HEIGHT: 56px" cellSpacing="0" cellPadding="0" width="438"
				...
				<TR>
					...
					<TD class="style29">
                        <asp:textbox id="txtccodcliente" tabIndex="5" runat="server" 
                            Width="197px" Font-Names="Verdana" Font-Size="8pt"
				...
				<TR>
					<TD style="WIDTH: 139px" align="right">
                        <asp:label id="Label32" runat="server" 
                            Width="101px" Height="16px" Font-Names="Verdana" Font-Size="8pt">Codigo Cta:</asp:label></TD>
					<TD style="WIDTH: 243px">
                        <asp:textbox id="txtcnrocta" tabIndex="5" runat="server" 
                            Width="198px" Font-Names="Verdana" Font-Size="8pt"
							Enabled="False" BorderColor="#2E6A99" BorderWidth="1px" Height="24px"></asp:textbox></TD>
					<TD>
						&nbsp;</TD>
				</TR>
				<TR>
					...
					<TD>
						<P align="center"><INPUT id="btnprocesar" style="BACKGROUND-POSITION: center center; BACKGROUND-IMAGE: url(Web/jpgs/btn_aplicar_b.jpg); WIDTH: 59px; BACKGROUND-REPEAT: no-repeat; HEIGHT: 56px; BACKGROUND-COLOR: transparent"
								type="button" runat="server" onclick="return btnprocesar_onclick()"></P>
					</TD>
				</TR>
				</TABLE>
		</TD>
				...
				<TR>
					<TD align="center">
						<TABLE id="Table7" borderColor="#ff9900" cellSpacing="0" cellPadding="0" bgColor="#CCFF33"
							...
							<TR>
								<TD class="style1">
                                    <asp:label id="Label33" runat="server" Width="131px" 
                                        Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" Height="18px">Saldo Cta. Garantia:</asp:label></TD>
								<TD class="style2" align="left">
                                    <asp:textbox id="txtSaldoGar" runat="server" 
                                        Width="102px" Font-Names="Verdana" Font-Size="8pt" 
                                        style="margin-left: 6px; margin-right: 0px" BorderColor="#2E6A99" 
                                        BorderWidth="1px" Height="25px" Enabled="False"></asp:textbox>                                        
                                </TD>
							</TR>
							<TR>
								<TD class="style1"><asp:label id="Label17" runat="server" Width="131px" 
                                        Font-Names="Verdana" Font-Size="8pt" Font-Bold="True" Height="18px">Monto a Entregar:</asp:label></TD>
								<TD class="style2" align="left">
				...
				<TR>
					<TD align="center" class="style3">
                        ...
                        <cc1:ConfirmButtonExtender ID="Button1_ConfirmButtonExtender" runat="server" 
                            ConfirmText="Seguro de Aplicar Garantía?" Enabled="True" 
                            TargetControlID="Button1">
                        </cc1:ConfirmButtonExtender>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button2" runat="server" Font-Names="Calibri" Font-Size="12pt" 
                            Text="Imprimir" Width="120px" Height="30px" />
                    </TD>
				</TR>
				<TR>
					<TD align="center">
						...
						<asp:textbox id="txtccodcli" runat="server" Width="16px" Font-Names="Verdana" Font-Size="8pt"
							Enabled="False" Visible="False"></asp:textbox>
                                        ...
                                        Font-Size="10pt" onchange="ActivaNumeroClientes()" 
                            Height="22px" Visible="False"></asp:dropdownlist>
						</TD>
				</TR>
			</TABLE>
		</TD>
