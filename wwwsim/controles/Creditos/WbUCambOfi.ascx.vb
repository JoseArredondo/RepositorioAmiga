...
Partial Class controles_Creditos_WbUCambOfi
    Inherits ucWBase
...
#End Region
    ...
    Private Sub cargarcombos()
        ...
        Me.CbxOficinas_Origen.Recuperar()
        Me.CbxOficinas_Destino.Recuperar()
    ...
    Public Sub CargarPorCliente(ByVal codigoCliente As String)
        ...
        CbxOficinas_Destino.Enabled = True
        Me.aplicar()
    End Sub
    ...
    Private Sub Procesar()
        ...
        Try
            ...
            Me.CbxOficinas_Origen.SelectedValue = entidadcremcre.cCodofi
    ...
    Private Sub Imprimir()
        ...
        crRpt.SetParameterValue("pnaldia", 0)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'Actualizar Oficina del Credito

        lnRetorno = mcremcre.Actualizar_Oficina_Credito(ViewState("pccodcta"), Me.CbxOficinas_Destino.SelectedValue.Trim)

        If lnRetorno = 0 Then
            codigoJs = "<script language='javascript'>alert('Ocurrio, Aviso SIM.NET ')</script>"
    ...
    Protected Sub CbxOficinas_Destino_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CbxOficinas_Destino.SelectedIndexChanged
