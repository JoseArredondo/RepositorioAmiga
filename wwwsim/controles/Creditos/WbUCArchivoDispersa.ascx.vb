...
Partial Class controles_Creditos_WbUCArchivoDispersa
    Inherits ucWBase
...
#End Region
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        array_d = omcredkar.Extrae_Archivo_Dispersador(Date.Parse(Me.TxtDfecvig.Text), Date.Parse(Me.TxtDfecvig.Text), Session("GCNOMINS"), _
                                                       Session("GCCTABCO"))
    ...
    Protected Sub btnReport_1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport_1.Click
        ...
        ds_Print = mcremcre.Extrae_Datos_Arhivo_Dispersion(Date.Parse(Me.TxtDfecvig.Text), Date.Parse(Me.TxtDfecvig.Text), 1)
        ...
        parameters(1, 1) = ("DISPERSIONES PENDIENTE DE GENERAR")
    ...
    Protected Sub btnReport_2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport_2.Click
        ...
        ds_Print = mcremcre.Extrae_Datos_Arhivo_Dispersion(Date.Parse(Me.TxtDfecvig.Text), Date.Parse(Me.TxtDfecvig.Text), 0)
        ...
        parameters(1, 0) = ("GCTITULO")
        parameters(1, 1) = ("DISPERSIONES REALIZAS")
