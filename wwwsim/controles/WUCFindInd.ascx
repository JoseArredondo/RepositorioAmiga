<%@ Control Language="vb" AutoEventWireup="false" Codefile="WUCFindInd.ascx.vb" Inherits="WUCFindInd"  %>
			...
			<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="472" border="0" style="WIDTH: 472px; HEIGHT: 147px">
				<TR>
					<TD style="WIDTH: 301px" align="right">
						<asp:radiobuttonlist id="rdbbusqueda" ForeColor="#16387C" Height="172px" 
							...
							<asp:ListItem Value="Documento &#250;nico">Cedula / D.P.I.</asp:ListItem>
						</asp:radiobuttonlist></TD>
					<TD style="WIDTH: 178px">
						<asp:radiobuttonlist id="rdbbusqueda2" ForeColor="#16387C" Height="117px" 
                            Font-Size="8pt" Font-Names="Century Gothic"
					...
					<TD style="WIDTH: 301px">
						<asp:radiobuttonlist id="rdbbusqueda3" runat="server" Width="131px" 
							...
							Height="173px" ForeColor="#16387C" BorderColor="Navy" BorderWidth="2px" BackColor="LightSkyBlue"
