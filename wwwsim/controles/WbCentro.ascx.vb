...
#Region " Metodos "
    ...
    Public Sub CargarPorCliente(ByVal codigoCliente As String)
        ...
        entidadcentros.cCodsol = Me.txtcodcli.Value.Trim
        ecentros.Obtenercentros(entidadcentros)
        Me.txtcnomcli.Text = entidadcentros.cnomgru.Trim
        Me.Textbox1.Text = entidadcentros.cnomgru.Trim
        Me.Textbox2.Text = entidadcentros.cdiareu.Trim
        Me.Textbox3.Text = entidadcentros.chora
        Me.Textbox4.Text = entidadcentros.cdirdom.Trim
        Me.Textbox5.Text = entidadcentros.cfrecreu.Trim
        Me.CheckBox1.Checked = entidadcentros.lactivo
        If IsDBNull(entidadcentros.cCodzon) Or entidadcentros.cCodzon = Nothing Then
        Else
            Me.cmbDep.SelectedValue = entidadcentros.cCodzon.Substring(0, 2)
            Me.cmbMun.SelectedValue = entidadcentros.cCodzon.Substring(0, 4)
            Me.cmbCant.SelectedValue = entidadcentros.cCodzon.Substring(0, 6)
        End If
