...
Partial Class wbtraslados
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load, Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.CuwTraslados1.Visible = False
            CuwTrasladosCas1.Visible = False
        End If
    End Sub
    Private Sub TabStrip1_SelectedIndexChange(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TabStrip1.SelectedIndexChange
        ...
        If TabStrip1.SelectedIndex = 1 Then
            ...
            Me.CuwTraslados1.Visible = True
            CuwTrasladosCas1.Visible = False
        End If
        If TabStrip1.SelectedIndex = 2 Then
            Me.wucfindcligru1.Visible = False
            Me.CuwTraslados1.Visible = False
            CuwTrasladosCas1.Visible = True
        End If
    End Sub
    ...
    Private Sub wucfindcligru1_Seleccionado(ByVal codigoCliente As String) Handles wucfindcligru1.Seleccionado
        If TabStrip1.SelectedIndex = 0 Then
            ...
            Me.CuwTraslados1.CargarDatosPorCuenta(codigoCliente)
        End If
