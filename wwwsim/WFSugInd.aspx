...
window.onunload=savemenustate
	...
	<BODY MS_POSITIONING="GridLayout" onresize="resizeVentana(divHeadImage);">
				...
				<TR>
					<TD>
						<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD style="WIDTH: 166px; HEIGHT: 33px; BACKGROUND-COLOR: #9fb7cf">
									<uc1:MenuIzquierdo id="MenuIzquierdo1" runat="server"></uc1:MenuIzquierdo></TD>
								<TD bgColor="#eff4f8">
									<uc1:CUWSugInd id="CUWSugInd1" runat="server"></uc1:CUWSugInd></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
