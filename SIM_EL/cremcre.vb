...
#Region " Privadas "
    ...
    Private _cnrodes As String

    Private _coficina As String

    Private _nprima As Decimal

    Private _ncosdir As Decimal

    Private _ncosind As Decimal
    ...
    Private _nsalcap As Double

    Private _nsalint As Double

    Private _nsalmor As Double

#End Region
 
#Region " Propiedades "
    Private _ccondicAnt As String
    Public Property ccondicAnt() As String
        Get
            Return _ccondicAnt
        End Get
    ...
    Private _nvalordesc As Decimal
    Public Property nvalordesc() As Decimal
        Get
            Return _nvalordesc
        End Get
    ...
    Private _nvaldemanda As Decimal
    Public Property nvaldemanda() As Decimal
        Get
            Return _nvaldemanda
        End Get
        Set(ByVal Value As Decimal)
    ...
    Private _csitactual As String
    Public Property csitactual() As String
        Get
            Return _csitactual
        End Get
        Set(ByVal Value As String)
    ...
    Private _dfecdemanda As Date
    Public Property dfecdemanda() As Date
        Get
            Return _dfecdemanda
        End Get
        Set(ByVal Value As Date)
        ...
        End Set
    End Property
    Private _cjuzgado As String
    Public Property cjuzgado() As String
        Get
            Return _cjuzgado
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Private _cnumjuicio As String
    Public Property cnumjuicio() As String
        Get
            Return _cnumjuicio
        End Get
        Set(ByVal Value As String)
        ...
        End Set
    End Property
    Private _cabogado As String
    Public Property cabogado() As String
        Get
            Return _cabogado
        End Get
        Set(ByVal Value As String)
    ...
    Private _cfueing As String
    Public Property cfueing() As String
        Get
            Return _cfueing
        End Get
        Set(ByVal Value As String)
    ...
    Private _ccodpag As String
    Public Property ccodpag() As String
        Get
            Return _ccodpag
        End Get
        Set(ByVal Value As String)
    ...
    Public Property ncuosug() As Decimal
        ...
        End Set
    End Property
    Public Property ncuosug0() As Decimal
        Get
            Return _ncuosug0
        End Get
        Set(ByVal Value As Decimal)
    ...
    Public Property cnrodes() As String
        Get
            Return _cnrodes
        End Get
        Set(ByVal Value As String)
    ...
    Public Property nprima() As Decimal
        Get
            Return _nprima
        End Get
        Set(ByVal Value As Decimal)
    ...
    Public Property ncosdir() As Decimal
        Get
            Return _ncosdir
        End Get
        Set(ByVal Value As Decimal)
    ...
    Public Property ncosind() As Decimal
        Get
            Return _ncosind
        End Get
        Set(ByVal Value As Decimal)
