...
#Region " Privadas "
    ...
    Private _dmenpro As DateTime
 
    Private _dultpro As DateTime
 
    Private _producto2 As String
 
    Private _nmonto2 As Decimal
...
#Region " Propiedades "
    ...
    Public Property dmenpro() As DateTime
        Get
            Return _dmenpro
        End Get
        Set(ByVal Value As DateTime)
    ...
    Public Property nmonto2() As Decimal
        Get
            Return _nmonto2
        End Get
        Set(ByVal Value As Decimal)
