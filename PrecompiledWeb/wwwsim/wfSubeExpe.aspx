<%@ page language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="wfSubeExpe, App_Web_epmxal5_" title="Carga de Expedientes" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
        ...
        <tr>
            <td>
                <iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" 
											...
											<iewc:Tab Text="Subir Archivo Digital"></iewc:Tab>										    
										</iewc:tabstrip>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <uc1:wucUploadExp ID="wucUploadExp1" runat="server" />
            </td>
        </tr>
    </table>
</asp:Content>
