<%@ Reference Control="~/controles/cuwcatalogo.ascx" %>
<%@ Reference Control="~/controles/cuwcatcon.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="CUWCatalogo" Src="controles/CUWCatalogo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="CUWCatCon" Src="controles/CUWCatCon.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wfCatCtb, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											AutoPostBack="True">
											<iewc:Tab Text="Dise&#241;o de Catalogo"></iewc:Tab>
											<iewc:Tab Text="Consulta de Catalogo"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 202px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
									<TD>
										<uc1:CUWCatCon id="CUWCatCon1" runat="server"></uc1:CUWCatCon>
										<uc1:CUWCatalogo id="CUWCatalogo1" runat="server"></uc1:CUWCatalogo></TD>
								</TR>
							</TABLE>
