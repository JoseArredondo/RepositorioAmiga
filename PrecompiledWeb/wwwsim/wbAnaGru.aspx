<%@ Reference Control="~/controles/cuwCamAna.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="wbAnaGru, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="WUCFindCre" Src="controles/WUCFindCre.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwCamAna" Src="controles/cuwCamAna.ascx" %>
...
<%@ Register src="controles/cuwanagru.ascx" tagname="cuwanagru" tagprefix="uc3" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc3:cuwanagru ID="cuwanagru1" runat="server" />
