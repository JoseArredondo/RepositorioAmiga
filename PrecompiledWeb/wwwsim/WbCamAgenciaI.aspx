...
<%@ page language="vb" autoeventwireup="false" inherits="WbCamagenciaI, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/WUCFindInd.ascx" tagname="WUCFindInd" tagprefix="uc5" %>
<%@ Register src="controles/ucCambiaagenciaI.ascx" tagname="ucCambiaagenciaI" tagprefix="uc2" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" 
											...
											AutoPostBack="True" Width="227px" Height="22px">
											<iewc:Tab Text="Busqueda"></iewc:Tab>
											<iewc:Tab Text="Cambio Agencia"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 202px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo>
                                        
                                    </TD>
									<TD>
                                        <uc2:ucCambiaagenciaI ID="ucCambiaagenciaI1" runat="server" />
