<%@ Reference Control="~/controles/ucgaslin.ascx" %>
<%@ Reference Control="~/controles/uclincre.ascx" %>
<%@ Reference Control="~/controles/ucbuslin.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="uclincre" Src="controles/uclincre.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucgaslin" Src="controles/ucgaslin.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucbuslin" Src="controles/ucbuslin.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wblineas, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" AutoPostBack="True" TabDefaultStyle="background-color:#000000;font-family:verdana;font-weight:bold;font-size:8pt;color:#ffffff;width:79;height:21;text-align:center;"
											...
											<iewc:Tab Text="Asignaci&#243;n de Gastos"></iewc:Tab>
											<iewc:Tab Text="L&#237;neas de Cr&#233;dito"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										<uc1:ucbuslin id="Ucbuslin2" runat="server"></uc1:ucbuslin>
										<uc1:ucgaslin id="Ucgaslin2" runat="server"></uc1:ucgaslin>
										<uc1:uclincre id="Uclincre2" runat="server"></uc1:uclincre></TD>
								</TR>
							</TABLE>
