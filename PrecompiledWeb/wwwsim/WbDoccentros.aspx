<%@ Reference Control="~/controles/cuwDoccentros.ascx" %>
<%@ Reference Control="~/controles/wbfindct.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwDoccentros" Src="controles/cuwDoccentros.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbFindct" Src="controles/WbFindct.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbDoccentros, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:WbFindct ID="WbFindct1" runat="server" />
                                        <uc1:cuwDoccentros ID="cuwDoccentros1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
