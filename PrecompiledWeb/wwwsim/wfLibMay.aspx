...
<%@ Register TagPrefix="uc1" TagName="cuwLibDMay" Src="controles/cuwLibDMay.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wfLibMay, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwLibDMay id="CuwLibDMay1" runat="server"></uc1:cuwLibDMay></TD>
								</TR>
							</TABLE>
