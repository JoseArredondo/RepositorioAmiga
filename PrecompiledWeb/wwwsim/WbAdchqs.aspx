...
<%@ Reference Control="~/controles/WbUsCAdChq.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="WbAdchqs, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="WbUsCAdChq" Src="controles/WbUsCAdChq.ascx" %>
...
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/WbUsFindChq.ascx" tagname="WbUsFindChq" tagprefix="uc2" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											AutoPostBack="True">
											<iewc:Tab Text="Adici&#243;n de Cheques"></iewc:Tab>
											<iewc:Tab Text="Catalogo"></iewc:Tab>
											<iewc:Tab Text="Buscar Cheques"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 202px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
									<TD>
										<uc1:WbUsCAdChq id="WbUsCAdChq1" runat="server"></uc1:WbUsCAdChq>
										<uc1:WbUsCatal id="WbUsCatal1" runat="server"></uc1:WbUsCatal>
										<uc2:WbUsFindChq ID="WbUsFindChq1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
