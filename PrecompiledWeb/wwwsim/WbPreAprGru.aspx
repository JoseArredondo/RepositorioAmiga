...
<%@ Reference Control="~/controles/CUWPreAprInd.ascx" %>
...
<%@ Register TagPrefix="uc1" TagName="CUWPreAprInd" Src="controles/CUWPreAprInd.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbPreAprGru, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" border="0">
								<TR>
									...
									<TD>
										...
										<iewc:tabstrip id="TabStrip1" AutoPostBack="True" TabDefaultStyle="background-color:#000000;font-family:verdana;font-weight:bold;font-size:8pt;color:#ffffff;width:79;height:21;text-align:center;"
											...
											<iewc:Tab Text="Pre-Aprobación de Credito"></iewc:Tab>
								...
								<TR>
									...
									<TD>
										<uc2:WUCFindGru ID="WUCFindGru1" runat="server" />
										<uc1:CuwPlan id="CuwPlan1" runat="server"></uc1:CuwPlan>
										<uc1:CUWPreAprInd ID="CUWPreAprInd1" runat="server" />
