...
<%@ page title="Desembolso Grupal" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="wbDesLote, App_Web_epmxal5_" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            <td>
				...
				<uc3:wbdesembg ID="wbdesembg2" runat="server" />
            </td>
        </tr>        
    </table>
</asp:Content>
