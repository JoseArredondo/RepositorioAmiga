<%@ Reference Control="~/controles/wbsaldo.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="wbCongelar, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register src="controles/CUWCongelar.ascx" tagname="CUWCongelar" tagprefix="uc4" %>
<%@ Register src="controles/CUWCongela.ascx" tagname="CUWCongela" tagprefix="uc5" %>
	...
	<BODY>
		<P>
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table2" style="BORDER-RIGHT: background thin solid; BORDER-TOP: background thin solid; Z-INDEX: 102; LEFT: 104px; BORDER-LEFT: background thin solid; WIDTH: 544px; BORDER-BOTTOM: background thin solid; POSITION: absolute; TOP: 16px; HEIGHT: 88px"
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Suspender"></iewc:Tab>
										    <iewc:Tab Text="Congelar" />
										</iewc:tabstrip><asp:ScriptManager ID="ScriptManager1" 
                    runat="server">
                </asp:ScriptManager>
                                    </TD>
								</TR>
								<TR>
									...
									<TD>
										<uc4:CUWCongelar ID="CUWCongelar1" runat="server" />
										<uc5:CUWCongela ID="CUWCongela1" runat="server" />
