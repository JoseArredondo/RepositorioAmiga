...
<%@ page language="vb" autoeventwireup="false" inherits="WbAdParti, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
				...
				<TABLE id="Table2" style="BORDER-RIGHT: background thin solid; BORDER-TOP: background thin solid; Z-INDEX: 102; LEFT: 104px; BORDER-LEFT: background thin solid; WIDTH: 608px; BORDER-BOTTOM: background thin solid; POSITION: absolute; TOP: 16px; HEIGHT: 88px"
					...
					<TR>
						<TD align="center">
							...
							<TD><uc1:wbuscadpartida id="WbUsCAdPartida1" runat="server"></uc1:wbuscadpartida><uc1:wbuscatal id="WbUsCatal1" runat="server"></uc1:wbuscatal><uc1:wbusfindpart id="WbUsFindPart1" runat="server"></uc1:wbusfindpart></TD>		
								</TR>
							</TABLE>
