...
<%@ page language="vb" autoeventwireup="false" inherits="WbRepRechazo, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/CuwEstimacion.ascx" tagname="CuwEstimacion" tagprefix="uc2" %>
<%@ Register src="controles/CuwRepRechazo.ascx" tagname="CuwRepRechazo" tagprefix="uc3" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc3:CuwRepRechazo ID="CuwRepRechazo1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
