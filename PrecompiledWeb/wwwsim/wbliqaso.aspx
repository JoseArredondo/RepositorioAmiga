<%@ Reference Control="~/controles/ucliquida.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="wbliqaso, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="ucliquida" Src="controles/ucliquida.ascx" %>
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Liquidaci&#243;n de Asociados"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										...
										<uc1:ucliquida id="Ucliquida1" runat="server"></uc1:ucliquida></TD>
								</TR>
							</TABLE>
