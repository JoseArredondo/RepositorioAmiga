<%@ Reference Control="~/controles/WbUsFindPart.ascx" %>
<%@ Reference Control="~/controles/WbUsCatal.ascx" %>
<%@ Reference Control="~/controles/WbUsCAdPartida.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbUsFindPart" Src="controles/WbUsFindPart.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbUsCatal" Src="controles/WbUsCatal.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbUsCAdPartida" Src="controles/WbUsCAdPartida.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbAdParBan, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/WbUsParBan.ascx" tagname="WbUsParBan" tagprefix="uc2" %>
<%@ Register src="controles/WbUsFindPartBan.ascx" tagname="WbUsFindPartBan" tagprefix="uc3" %>
		...
		<P>
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table2" style="BORDER-RIGHT: background thin solid; BORDER-TOP: background thin solid; Z-INDEX: 102; LEFT: 104px; BORDER-LEFT: background thin solid; WIDTH: 608px; BORDER-BOTTOM: background thin solid; POSITION: absolute; TOP: 16px; HEIGHT: 88px"
					...
					<TR>
						<TD style="HEIGHT: 27px" align="center"><uc1:headlargo id="HeadLargo1" runat="server"></uc1:headlargo></TD>
					</TR>
					<TR>
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											AutoPostBack="True">
											<iewc:Tab Text="Adici&#243;n de Partidas"></iewc:Tab>
											<iewc:Tab Text="Catalogo"></iewc:Tab>
											<iewc:Tab Text="Buscar Partidas"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 202px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
							<TD><uc1:wbuscatal id="WbUsCatal1" runat="server"></uc1:wbuscatal>
                                <uc3:WbUsFindPartBan ID="WbUsFindPartBan1" runat="server" />
                                <uc2:WbUsParBan ID="WbUsParBan1" runat="server" />
                                    </TD>		
								</TR>
							</TABLE>
							<asp:label id="Label1" runat="server" Font-Size="6pt" Font-Names="Verdana" ForeColor="MidnightBlue"
								Font-Bold="True" BackColor="Transparent">copyright@ 2006 FUNDAMICRO - El Salvador</asp:label></TD>
					</TR>
				</TABLE>
				&nbsp;
			</FORM>
