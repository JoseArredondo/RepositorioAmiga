...
<%@ page language="vb" autoeventwireup="false" inherits="wfReportes, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="Reportes" Src="controles/Reportes.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD>
										<uc1:Reportes id="Reportes1" runat="server"></uc1:Reportes></TD>
								</TR>
							</TABLE>
