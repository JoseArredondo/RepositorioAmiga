...
<%@ Register TagPrefix="uc1" TagName="WUCLibMdet" Src="controles/WUCLibMdet.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WfLibMdet, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:WUCLibMdet id="WUCLibMdet1" runat="server"></uc1:WUCLibMdet></TD>
								</TR>
							</TABLE>
