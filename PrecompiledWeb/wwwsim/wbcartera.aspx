<%@ Register TagPrefix="uc1" TagName="ucingresos" Src="controles/ucingresos.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbcartera, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="uccartera" Src="controles/uccartera.ascx" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD style="WIDTH: 286px; HEIGHT: 2px">
									<uc1:encabezado id="Encabezado2" runat="server"></uc1:encabezado></TD>
							</TR>
						</TABLE>
							...
							<TR>
								...
								<TD>
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD style="WIDTH: 183px" bgColor="#ffd700">
											...
											<TD>
												<uc1:uccartera id="Uccartera1" runat="server"></uc1:uccartera></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
