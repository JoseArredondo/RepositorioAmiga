...
<%@ page language="vb" autoeventwireup="false" inherits="wfgenBal, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="cuwGenBal" Src="controles/cuwGenBal.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwGenBal id="CuwGenBal1" runat="server"></uc1:cuwGenBal></TD>
								</TR>
							</TABLE>
