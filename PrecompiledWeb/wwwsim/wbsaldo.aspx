...
<%@ page language="vb" autoeventwireup="false" inherits="wbsaldo1, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Saldo a una Fecha"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										...
										<uc1:wbsaldo id="Wbsaldo2" runat="server"></uc1:wbsaldo></TD>
								</TR>
							</TABLE>
