<%@ Reference Control="~/controles/cuwRepHip.ascx" %>
<%@ Reference Control="~/controles/WUCFindCre.ascx" %>
<%@ Reference Control="~/controles/cuwGarHip.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="WbGarHip, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Garant&#237;as Hipotecarias"></iewc:Tab>
											<iewc:Tab Text="Reportes Garantias Hipotecarias"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										...
										<uc1:cuwGarHip id="CuwGarHip1" runat="server"></uc1:cuwGarHip>
										<uc1:cuwRepHip id="CuwRepHip1" runat="server"></uc1:cuwRepHip></TD>
								</TR>
							</TABLE>
