...
<%@ page language="vb" autoeventwireup="false" inherits="wfBalance, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="cuwDisBal1" Src="controles/cuwDisBal1.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwDisBal1 id="CuwDisBal11" runat="server"></uc1:cuwDisBal1></TD>
								</TR>
							</TABLE>
