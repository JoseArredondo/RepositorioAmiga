<%@ page title="" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="Wbdeletesol, App_Web_epmxal5_" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>

<%@ Register assembly="Microsoft.Web.UI.WebControls" namespace="Microsoft.Web.UI.WebControls" tagprefix="iewc" %>
<%@ Register src="controles/Creditos/WbUCFindCred.ascx" tagname="WbUCFindCred" tagprefix="uc5" %>

<%@ Register src="controles/Creditos/WbUCEliminaSol.ascx" tagname="WbUCEliminaSol" tagprefix="uc6" %>
        ...
        <tr>
            <td>
                <iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" 
											...
											<iewc:Tab Text="Eliminar Solicitud"></iewc:Tab>										    
										</iewc:tabstrip>
            </td>
        </tr>
        <tr>
            <td>
                <uc6:WbUCEliminaSol ID="WbUCEliminaSol1" runat="server" />
