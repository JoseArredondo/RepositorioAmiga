...
<%@ page language="vb" autoeventwireup="false" inherits="wbReversionPagoOtrosIngresos, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/WbFind.ascx" tagname="WbFind" tagprefix="uc2" %>
<%@ Register src="controles/wbanulapagosOtrosIngresos.ascx" tagname="wbanulapagosOtrosIngresos" tagprefix="uc3" %>
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Revertir Pago"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 166px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo>                                        
                                    </TD>
									<TD>																			    
                                        <uc2:WbFind ID="WbFind1" runat="server" />
                                        <uc3:wbanulapagosOtrosIngresos ID="wbanulapagosOtrosIngresos1" runat="server" />
                                    </TD>
                                    <td>&nbsp;</td>
								</TR>
							</TABLE>
