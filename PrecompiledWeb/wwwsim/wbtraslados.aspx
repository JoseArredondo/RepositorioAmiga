...
<%@ page language="vb" autoeventwireup="false" inherits="wbtraslados, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="CuwTraslados" Src="controles/CuwTraslados.ascx" %>
...
<%@ Register src="controles/CuwTrasladosCas.ascx" tagname="CuwTrasladosCas" tagprefix="uc3" %>
	...
	<BODY>
		<P>
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table2" style="BORDER-RIGHT: background thin solid; BORDER-TOP: background thin solid; Z-INDEX: 102; LEFT: 104px; BORDER-LEFT: background thin solid; WIDTH: 656px; BORDER-BOTTOM: background thin solid; POSITION: absolute; TOP: 16px; HEIGHT: 110px"
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Traslados de Cr&#233;dito"></iewc:Tab>
										    <iewc:Tab Text="Masivo" />
										</iewc:tabstrip>
                <asp:ScriptManager ID="ScriptManager1" runat="server">
								...
								<TR>
									...
									<TD>
										...
										<uc1:CuwTraslados id="CuwTraslados1" runat="server"></uc1:CuwTraslados>
                                        <uc3:CuwTrasladosCas ID="CuwTrasladosCas1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
