...
<%@ Reference Control="~/controles/CUWAprInd.ascx" %>
<%@ Reference Control="~/controles/WUCFindInd.ascx" %>
...
<%@ Register TagPrefix="uc1" TagName="WUCFindInd" Src="controles/WUCFindInd.ascx" %>
<%@ Register TagPrefix="uc1" TagName="CUWAprInd" Src="controles/CUWAprInd.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbAprUno, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
	...
	<BODY>
		<P>
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table2" style="BORDER-RIGHT: background thin solid; BORDER-TOP: background thin solid; Z-INDEX: 101; LEFT: 104px; BORDER-LEFT: background thin solid; WIDTH: 608px; BORDER-BOTTOM: background thin solid; POSITION: absolute; TOP: 16px; HEIGHT: 88px"
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:WUCFindInd ID="WUCFindInd1" runat="server" />
										<uc1:CuwPlan id="CuwPlan1" runat="server"></uc1:CuwPlan>
										<uc1:WUCGarantias id="WUCGarantias1" runat="server"></uc1:WUCGarantias>
										<uc1:CUWAprInd id="CUWAprInd1" runat="server"></uc1:CUWAprInd></TD>
								</TR>
							</TABLE>
