...
<%@ page language="vb" autoeventwireup="false" inherits="WbCamLineaI, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register src="controles/ucCambiaLineaI.ascx" tagname="ucCambiaLineaI" tagprefix="uc3" %>
<%@ Register src="controles/WUCFindInd.ascx" tagname="WUCFindInd" tagprefix="uc5" %>
<%@ Register src="controles/wucfindcligru.ascx" tagname="wucfindcligru" tagprefix="uc7" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Cambio Linea"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										<uc7:wucfindcligru ID="wucfindcligru1" runat="server" />
                                        <uc3:ucCambiaLineaI ID="ucCambiaLineaI1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
