...
<%@ Register TagPrefix="uc1" TagName="cuwConGen" Src="controles/cuwConGen.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wfConGen, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwConGen id="CuwConGen1" runat="server"></uc1:cuwConGen></TD>
								</TR>
							</TABLE>
