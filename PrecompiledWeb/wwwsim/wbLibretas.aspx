...
<%@ Reference Control="~/controles/cuwlibretas.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="WbLibretas, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="cuwlibretas" Src="controles/cuwlibretas.ascx" %>
					...
					<TR>
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD style="WIDTH: 183px; HEIGHT: 19px"></TD>
									<TD style="HEIGHT: 19px">
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Libretas"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										...
										<uc1:cuwlibretas id="Cuwlibretas1" runat="server"></uc1:cuwlibretas></TD>
								</TR>
							</TABLE>
