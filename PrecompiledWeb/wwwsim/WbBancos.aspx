<%@ Reference Control="~/controles/CUWBancos.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbBancos, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="CUWBancos" Src="controles/CUWBancos.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:CUWBancos id="CUWBancos1" runat="server"></uc1:CUWBancos></TD>
								</TR>
							</TABLE>
