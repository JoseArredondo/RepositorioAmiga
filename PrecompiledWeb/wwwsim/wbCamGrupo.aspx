<%@ Reference Control="~/controles/cuwCamcentro.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="Wbcamgrupo, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="WUCFindCre" Src="controles/WUCFindCre.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwCamcentro" Src="controles/cuwCamcentro.ascx" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Cambiar Centro"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
									    ...
									    <uc1:cuwcamcentro ID="cuwCamcentro1" runat="server"></uc1:cuwcamcentro>
										</TD>
								</TR>
							</TABLE>
