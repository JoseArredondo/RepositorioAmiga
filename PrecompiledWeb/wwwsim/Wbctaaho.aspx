...
<%@ Reference Control="~/controles/ucbenaho.ascx" %>
<%@ Reference Control="~/controles/ucctaaho.ascx" %>
...
<%@ Register TagPrefix="uc1" TagName="ucbenaho" Src="controles/ucbenaho.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucctaaho" Src="controles/ucctaaho.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbFind" Src="controles/WbFind.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="Wbctaaho, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/wbAutoFirmas.ascx" tagname="wbAutoFirmas" tagprefix="uc2" %>
<%@ Register src="controles/WbContratoAho.ascx" tagname="WbContratoAho" tagprefix="uc3" %>
<%@ Register src="controles/CuwFirmas.ascx" tagname="CuwFirmas" tagprefix="uc4" %>
<%@ Register src="controles/Cuwbusaho.ascx" tagname="Cuwbusaho" tagprefix="uc5" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Apertura de Cuentas"></iewc:Tab>
											<iewc:Tab Text="Beneficiarios"></iewc:Tab>
											<iewc:Tab Text="Autoriz. Firmas"></iewc:Tab>
                                            <iewc:Tab Text="Buscar Cta. Ahorro" />
										</iewc:tabstrip>
								...
								<TR>
									...
									<TD>
										...
										<uc1:ucctaaho id="Ucctaaho1" runat="server"></uc1:ucctaaho>
										<uc1:ucbenaho id="Ucbenaho1" runat="server"></uc1:ucbenaho>
										<uc5:Cuwbusaho ID="Cuwbusaho1" runat="server" />
                                        <uc4:CuwFirmas ID="CuwFirmas1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
