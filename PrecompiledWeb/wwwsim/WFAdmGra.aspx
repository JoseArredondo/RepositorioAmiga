...
<%@ Register TagPrefix="uc1" TagName="cuwGraf" Src="controles/cuwGraf.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WFAdmGra, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwGraf id="CuwGraf1" runat="server"></uc1:cuwGraf></TD>
								</TR>
							</TABLE>
