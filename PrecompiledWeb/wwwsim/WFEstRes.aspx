...
<%@ Register TagPrefix="uc1" TagName="cuwDisRes1" Src="controles/cuwDisRes1.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WFEstRes, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwDisRes1 id="CuwDisRes11" runat="server"></uc1:cuwDisRes1></TD>
								</TR>
							</TABLE>
