<%@ Reference Control="~/controles/uccreausu.ascx" %>
<%@ Reference Control="~/controles/ucregistro.ascx" %>
<%@ Reference Control="~/controles/ucbususu.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucregistro" Src="controles/ucregistro.ascx" %>
<%@ Register TagPrefix="uc1" TagName="uccreausu" Src="controles/uccreausu.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucbususu" Src="controles/ucbususu.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbregistro, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											AutoPostBack="True">
											<iewc:Tab Text="Buscar Usuarios"></iewc:Tab>
											<iewc:Tab Text="Permisos"></iewc:Tab>
											<iewc:Tab Text="Crear Usuarios"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 202px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
									<TD>
										<uc1:ucbususu id="Ucbususu1" runat="server"></uc1:ucbususu>
										<uc1:uccreausu id="Uccreausu1" runat="server"></uc1:uccreausu>
										<uc1:ucregistro id="Ucregistro1" runat="server"></uc1:ucregistro></TD>
								</TR>
							</TABLE>
