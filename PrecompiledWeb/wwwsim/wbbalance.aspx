<%@ page language="vb" autoeventwireup="false" inherits="wbbalance, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="WbUsBalance" Src="controles/WbUsBalance.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:WbUsBalance id="WbUsBalance1" runat="server"></uc1:WbUsBalance></TD>
								</TR>
							</TABLE>
