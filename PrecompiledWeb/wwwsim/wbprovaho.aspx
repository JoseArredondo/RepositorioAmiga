...
<%@ Register TagPrefix="uc1" TagName="ucprovaporta" Src="controles/ucprovaporta.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbprovaho, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:ucprovaporta id="Ucprovaporta1" runat="server"></uc1:ucprovaporta></TD>
								</TR>
							</TABLE>
