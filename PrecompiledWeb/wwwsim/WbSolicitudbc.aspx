...
<%@ Reference Control="~/controles/WbSolcredbc.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="WbSolcredbc" Src="controles/WbSolcredbc.ascx" %>
...
<%@ page language="vb" autoeventwireup="false" inherits="WbSolicitudbc, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:WbFindct id="WbFindct1" runat="server"></uc1:WbFindct>
										<uc1:WbSolcredbc id="WbSolcredbc2" runat="server"></uc1:WbSolcredbc></TD>
								</TR>
							</TABLE>
