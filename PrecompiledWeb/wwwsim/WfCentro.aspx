<%@ Reference Control="~/controles/wbcentro.ascx" %>
...
<%@ Register TagPrefix="uc1" TagName="Wbcentro" Src="controles/Wbcentro.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbFindct" Src="controles/WbFindct.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="Wfcentro, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="ABC del Centro"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
                                        ...
                                        <uc1:Wbcentro ID="Wbcentro1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
