...
<%@ page language="vb" autoeventwireup="false" inherits="WbCanCert, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/cancelacion_plazo.ascx" tagname="cancelacion_plazo" tagprefix="uc2" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc2:cancelacion_plazo ID="cancelacion_plazo1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
