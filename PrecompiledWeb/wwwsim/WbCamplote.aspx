...
<%@ page language="vb" autoeventwireup="false" inherits="WbCamplote, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register src="controles/CUWCamplote.ascx" tagname="CUWCamplote" tagprefix="uc4" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									...
									<TD>
										<uc4:CUWCamplote ID="CUWCamplote1" runat="server" />
