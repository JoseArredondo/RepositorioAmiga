...
<%@ page language="vb" autoeventwireup="false" inherits="wbprovpla, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="ucprovpla" Src="controles/ucprovpla.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:ucprovpla id="Ucprovpla1" runat="server"></uc1:ucprovpla></TD>
								</TR>
							</TABLE>
