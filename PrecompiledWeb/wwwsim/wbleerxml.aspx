...
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbleerxml, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="ucleerxml" Src="controles/ucleerxml.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:ucleerxml id="Ucleerxml1" runat="server"></uc1:ucleerxml></TD>
								</TR>
							</TABLE>
