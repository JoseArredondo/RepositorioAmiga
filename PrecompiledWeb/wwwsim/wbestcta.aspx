<%@ Register TagPrefix="uc1" TagName="wbestcta" Src="controles/wbestcta.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbestcta1, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
window.onunload=savemenustate
	...
	<BODY onresize="resizeVentana(divHeadImage);">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 935px; POSITION: absolute; TOP: 8px; HEIGHT: 48px"
				...
				<TR>
					<TD style="WIDTH: 171px; HEIGHT: 37px; BACKGROUND-COLOR: #9fb7cf">
						<uc1:MenuIzquierdo id="MenuIzquierdo1" runat="server"></uc1:MenuIzquierdo></TD>
					<TD style="HEIGHT: 37px; BACKGROUND-COLOR: #eff4f8">
						<uc1:wbestcta id="Wbestcta2" runat="server"></uc1:wbestcta></TD>
				</TR>
			</TABLE>
		</FORM>
