<%@ Reference Control="~/controles/uccalmora.ascx" %>
...
<%@ Register TagPrefix="uc1" TagName="uccalmora" Src="controles/uccalmora.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbcalcmora, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Calculo de Mora"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 202px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
									<TD><uc1:wucfindcre id="WUCFindCre1" runat="server"></uc1:wucfindcre>
										<uc1:uccalmora id="Uccalmora1" runat="server"></uc1:uccalmora></TD>
								</TR>
							</TABLE>
