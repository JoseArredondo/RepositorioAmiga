...
<%@ page language="vb" autoeventwireup="false" inherits="WbSolbcolote, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register src="controles/WbSollote.ascx" tagname="WbSollote" tagprefix="uc3" %>
<%@ Register src="controles/WbFindgr.ascx" tagname="WbFindgr" tagprefix="uc4" %>
<%@ Register src="controles/WbFindbc.ascx" tagname="WbFindbc" tagprefix="uc5" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc5:WbFindbc ID="WbFindbc1" runat="server" />
                                        <uc3:WbSollote ID="WbSollote1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
