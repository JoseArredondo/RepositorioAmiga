<%@ Control Language="vb" AutoEventWireup="false" Codebehind="wbpagosATM.ascx.vb" Inherits="wwwSIM.wbpagosATM" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
