<%@ Control Language="vb" AutoEventWireup="false" Codebehind="cuwGenBal.ascx.vb" Inherits="wwwSIM.cuwGenBal" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
