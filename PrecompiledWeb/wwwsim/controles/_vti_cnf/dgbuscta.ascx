<%@ Control Language="vb" AutoEventWireup="false" Codebehind="dgbuscta.ascx.vb" Inherits="wwwSIM.dgbuscta" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
