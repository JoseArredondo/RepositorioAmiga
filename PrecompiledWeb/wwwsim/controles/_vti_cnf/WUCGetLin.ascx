<%@ Control Language="vb" AutoEventWireup="false" Codebehind="WUCGetLin.ascx.vb" Inherits="wwwSIM.WUCGetLin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
