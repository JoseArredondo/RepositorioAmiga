<%@ Control Language="vb" AutoEventWireup="false" Codebehind="uchistorial.ascx.vb" Inherits="wwwSIM.uchistorial" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<P>
