<%@ Control Language="vb" AutoEventWireup="false" Codebehind="uccartera.ascx.vb" Inherits="wwwSIM.uccartera" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
