<%@ Control Language="vb" AutoEventWireup="false" Codebehind="WbCreditosClientes.ascx.vb" Inherits="wwwSIM.WbCreditosClientes" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
