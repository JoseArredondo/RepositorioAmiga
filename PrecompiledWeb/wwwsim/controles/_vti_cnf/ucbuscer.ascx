<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucbuscer.ascx.vb" Inherits="wwwSIM.ucbuscer" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
