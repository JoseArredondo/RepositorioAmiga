<%@ control language="vb" autoeventwireup="false" inherits="CUWAprInd, App_Web_yl8dokps" %>
                ...
                <tr>
                    <td class="style27">
                        <table cellpadding="0" cellspacing="0" class="style28">
                            ...
                            <tr>
                                <td align="right" class="style31">
							<asp:label id="Label9" runat="server" Width="87px" Font-Names="Verdana" Font-Size="8pt" ForeColor="#16387C">Garantías:</asp:label>
                                </td>
                                <td class="style45">
