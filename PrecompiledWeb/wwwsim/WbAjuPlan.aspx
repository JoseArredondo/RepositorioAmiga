...
<%@ page language="vb" autoeventwireup="false" inherits="WbAjuPlan, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register src="controles/wucReestru.ascx" tagname="wucReestru" tagprefix="uc3" %>
<%@ Register src="controles/wucAjuPlan.ascx" tagname="wucAjuPlan" tagprefix="uc4" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Ajuste Plan"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<uc2:wucfindcligru ID="wucfindcligru1" runat="server" />
									    <uc4:wucAjuPlan ID="wucAjuPlan1" runat="server" />
									</TD>
								</TR>
							</TABLE>
