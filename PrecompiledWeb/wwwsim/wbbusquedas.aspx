...
<%@ Register TagPrefix="uc1" TagName="wbbusqudas" Src="controles/wbbusqudas.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbbusquedas, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TR>
								...
								<TD>
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD style="WIDTH: 303px" bgColor="#ffd700">
											...
											<TD>
												<uc1:wbbusqudas id="Wbbusqudas1" runat="server"></uc1:wbbusqudas></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
