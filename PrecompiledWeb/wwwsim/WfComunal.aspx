<%@ Reference Control="~/controles/wbComunal.ascx" %>
<%@ Reference Control="~/controles/wbfindbc.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbComunal" Src="controles/WbComunal.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbFindbc" Src="controles/WbFindbc.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="Wfcomunal, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="MenuIzquierdo" Src="controles/MenuIzquierdo.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/WbFindbc.ascx" tagname="WbFindbc" tagprefix="uc2" %>
<%@ Register src="controles/WbFind.ascx" tagname="WbFind" tagprefix="uc3" %>
					...
					<TR>
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD class="style10"></TD>
									<TD class="style11"><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" 
											...
											AutoPostBack="True" Width="326px" Height="27px">
											<iewc:Tab Text="Busqueda"></iewc:Tab>
											<iewc:Tab Text="ABC del BC"></iewc:Tab>
								...
								<TR>
									...
									<TD>
										<uc2:WbFindbc ID="WbFindbc1" runat="server" />
                                        <uc3:WbFind ID="WbFind1" runat="server" />
                                        <uc1:WbComunal ID="WbComunal1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
