...
<%@ page language="vb" autoeventwireup="false" inherits="wbreping, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
	...
	<BODY onresize="resizeVentana(divHeadImage);">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
					<TD style="WIDTH: 171px; HEIGHT: 14px; BACKGROUND-COLOR: #9fb7cf">
						<uc1:MenuIzquierdo id="MenuIzquierdo1" runat="server"></uc1:MenuIzquierdo></TD>
					<TD style="HEIGHT: 27px; BACKGROUND-COLOR: #eff4f8">
						<uc1:ucingresos id="Ucingresos1" runat="server"></uc1:ucingresos></TD>
				</TR>
			</TABLE>
		</FORM>
