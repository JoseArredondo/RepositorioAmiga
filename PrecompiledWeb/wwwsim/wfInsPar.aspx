...
<%@ page language="vb" autoeventwireup="false" inherits="wfInsPar, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="cuwInsPar" Src="controles/cuwInsPar.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:cuwInsPar id="CuwInsPar1" runat="server"></uc1:cuwInsPar></TD>
								</TR>
							</TABLE>
