...
<%@ page language="vb" autoeventwireup="false" inherits="wbreportesaho, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="ucreportesaho" Src="controles/ucreportesaho.ascx" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:ucreportesaho id="Ucreportesaho1" runat="server"></uc1:ucreportesaho></TD>
								</TR>
							</TABLE>
