<%@ Reference Control="~/controles/ucestadogru.ascx" %>
...
<%@ Register TagPrefix="uc2" TagName="ucestadogru" Src="controles/ucestadogru.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wfEstadoG, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="Estado de Cuenta"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									...
									<TD>
										...
										<uc2:ucestadogru ID="ucestadogru1" runat="server"></uc2:ucestadogru>
                                    </TD>
								</TR>
							</TABLE>
