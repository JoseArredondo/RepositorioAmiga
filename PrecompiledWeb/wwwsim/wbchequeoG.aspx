<%@ Reference Control="~/controles/ucchequeoG.ascx" %>
...
<%@ Register TagPrefix="uc1" TagName="ucchequeoG" Src="controles/ucchequeoG.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbchequeoG, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
						...
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									...
									<TD>
										<uc1:WFindCreGB ID="WFindCreGB1" runat="server" />
										<uc1:ucchequeoG ID="ucchequeoG1" runat="server"></uc1:ucchequeoG>
                                    </TD>
								</TR>
							</TABLE>
