...
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbreferencia, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="wucDatRef" Src="controles/wucDatRef.ascx" %>
					...
					<TR>
						<TD align="center">
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<TD>
										<uc1:wucDatRef id="WucDatRef1" runat="server"></uc1:wucDatRef></TD>
								</TR>
							</TABLE>
