...
<%@ page language="vb" autoeventwireup="false" inherits="WbEncuesta, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register src="controles/WbNBI.ascx" tagname="WbNBI" tagprefix="uc3" %>
<%@ Register src="controles/WbCBA.ascx" tagname="WbCBA" tagprefix="uc4" %>
<%@ Register src="controles/WbEncuestap.ascx" tagname="WbEncuestap" tagprefix="uc5" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" AutoPostBack="True" TabDefaultStyle="background-color:#000000;font-family:verdana;font-weight:bold;font-size:8pt;color:#ffffff;width:79;height:21;text-align:center;"
											...
											<iewc:Tab Text="Encuesta PPI"></iewc:Tab>
										    <iewc:Tab Text="NBI" />
										    <iewc:Tab Text="CBA/CBV" />
										</iewc:tabstrip>
								...
								<TR>
									...
									<TD>
                                        ...
                                        <uc3:WbNBI ID="WbNBI1" runat="server" />
                                        <uc5:WbEncuestap ID="WbEncuestap1" runat="server" />
                                        <uc4:WbCBA ID="WbCBA1" runat="server" />
								</TD>
								</TR>
							</TABLE>
