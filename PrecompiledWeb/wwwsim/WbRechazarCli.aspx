...
<%@ page title="Rechazar Cliente" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="WbRechazarCli, App_Web_epmxal5_" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>

<%@ Register assembly="Microsoft.Web.UI.WebControls" namespace="Microsoft.Web.UI.WebControls" tagprefix="iewc" %>


<%@ Register src="controles/WbFind.ascx" tagname="WbFind" tagprefix="uc1" %>
<%@ Register src="controles/WbRechazar.ascx" tagname="WbRechazar" tagprefix="uc2" %>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%">
        ...
        <tr>
            <td>
                ...
                <uc2:WbRechazar ID="WbRechazar1" runat="server" />
            </td>
        </tr>
    </table>
</asp:Content>
