<%@ Reference Control="~/controles/cuwDocumentos.ascx" %>
<%@ Reference Control="~/controles/wbfindgr.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwDocumentos" Src="controles/cuwDocumentos.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WbFindgr" Src="controles/WbFindgr.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbDocumentos, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
							...
							<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD><iewc:tabstrip id="TabStrip1" runat="server" Font-Size="Larger" Font-Names="Century Gothic" TabSelectedStyle="background-color:#ffffff;color:#000000;"
											...
											<iewc:Tab Text="ABC del Grupo"></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 183px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
									<TD>
										<uc1:WbFindgr id="WbFindgr1" runat="server"></uc1:WbFindgr>
										<uc1:cuwDocumentos ID="CuwDocumentos1" runat="server" />
                                    </TD>
								</TR>
							</TABLE>
