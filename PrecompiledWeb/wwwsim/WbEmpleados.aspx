...
<%@ Register TagPrefix="uc1" TagName="cuwempleados" Src="controles/cuwempleados.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwplanillas" Src="controles/cuwplanillas.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="WbEmpleados, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
<%@ Register TagPrefix="uc1" TagName="cuwplanictb" Src="controles/cuwplanictb.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwRepHip" Src="controles/cuwRepHip.ascx" %>
<%@ Register TagPrefix="uc1" TagName="cuwGarHip" Src="controles/cuwGarHip.ascx" %>
...
window.onunload=savemenustate
	...
	<BODY background="imagenes/fondo.jpg" MS_POSITIONING="GridLayout">
		<P>
								...
								<TR>
									...
									<TD>
										<iewc:tabstrip id="TabStrip1" runat="server" Font-Names="Century Gothic" Font-Size="Larger" AutoPostBack="True"
											...
											Width="248px">
											<iewc:Tab Text="Control de Planilla"></iewc:Tab>
											<iewc:Tab Text="Impresi&#243;n de Planillas"></iewc:Tab>
											<iewc:Tab Text="Generar Partida C."></iewc:Tab>
										</iewc:tabstrip></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 166px"><uc1:menuizquierdo id="MenuIzquierdo1" runat="server"></uc1:menuizquierdo></TD>
									<TD>
										<uc1:cuwempleados id="Cuwempleados1" runat="server"></uc1:cuwempleados>
										<uc1:cuwplanillas id="Cuwplanillas1" runat="server"></uc1:cuwplanillas>
										<uc1:cuwplanictb id="Cuwplanictb1" runat="server"></uc1:cuwplanictb></TD>
								</TR>
							</TABLE>
