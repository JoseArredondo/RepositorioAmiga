<%@ Reference Control="~/controles/ucchequeo.ascx" %>
<%@ Reference Control="~/controles/WUCFindCrex.ascx" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uc1" TagName="HeadLargo" Src="controles/HeadLargo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="WUCFindCrex" Src="controles/WUCFindCrex.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ucchequeo" Src="controles/ucchequeo.ascx" %>
<%@ page language="vb" autoeventwireup="false" inherits="wbchequeo, App_Web_4ra5sobm" enableEventValidation="false" maintainScrollPositionOnPostBack="true" %>
					...
					<TR>
						<TD align="center">
							...
							<asp:label id="Label1" runat="server" Font-Size="6pt" Font-Names="Verdana" BackColor="Transparent"
								Font-Bold="True" ForeColor="MidnightBlue">copyright@ 2006 FUNDAMICRO - El 
